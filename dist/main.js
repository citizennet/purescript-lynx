...
(function(exports) {
  ...
  var reflectType = function (v) {
      ...
      throw new Error("Failed pattern match at Lynx.Data.Expr (line 98, column 1 - line 98, column 34): " + [ v.constructor.name ]);
  };                        
  var print = function (v) {
      ...
      throw new Error("Failed pattern match at Lynx.Data.Expr (line 107, column 9 - line 113, column 16): " + [ v.constructor.name ]);
  };
  ...
  var evalExpr = function (get) {
      return function (v) {
          ...
          throw new Error("Failed pattern match at Lynx.Data.Expr (line 254, column 16 - line 271, column 60): " + [ v.constructor.name ]);
      };
  };                        
          ...
          return function (page) {
              var setField = function (field) {
                  if (key === field.key) {
                      if (field.input instanceof Currency) {
                          return {
                              ...
                              input: new Currency({
                                  ...
                                  value: Data_Functor.map(functorInputSource)(Lynx_Data_Expr.Val.create)(val),
                      ...
                      throw new Error("Failed pattern match at Lynx.Data.Form (line 262, column 26 - line 270, column 63): " + [ field.input.constructor.name ]);
                  };
                  if (Data_Boolean.otherwise) {
                      return field;
                  };
  ...
  var foldableInputSource = new Data_Foldable.Foldable(function (dictMonoid) {
      return function (f) {
          return function (v) {
              ...
              throw new Error("Failed pattern match at Lynx.Data.Form (line 115, column 15 - line 119, column 26): " + [ v.constructor.name ]);
          };
      };
  }, function (f) {
  ...
  var traversableInputSource = new Data_Traversable.Traversable(function () {
      ...
      return function (f) {
          return function (v) {
              ...
              throw new Error("Failed pattern match at Lynx.Data.Form (line 125, column 16 - line 129, column 36): " + [ v.constructor.name ]);
          };
      };
  });
  var firstName = {
...
(function(exports) {
  ...
  var $$eval = function (v) {
      if (v instanceof Initialize) {
          return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value0)(Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)((function () {
                  ...
                  throw new Error("Failed pattern match at Lynx.Page.Form (line 195, column 14 - line 197, column 42): " + [ v1.route.constructor.name ]);
              })())(function (v2) {
                  return Data_Bifoldable.bifor_(Network_RemoteData.bifoldableRemoteData)(Halogen_Query_HalogenM.applicativeHalogenM)(v2)(function (e) {
                      ...
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                          ...
                          $38.values = Lynx_Data_Form.keys(page);
                          return $38;
                      }))(function () {
              ...
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Data_Traversable["for"](Halogen_Query_HalogenM.applicativeHalogenM)(Data_Either.traversableEither)(evaled$prime)(function (page) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Data_Foldable.for_(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Foldable.foldableArray)(page.contents)(function (section) {
                      return Data_Foldable.for_(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Foldable.foldableArray)(section.contents)(function (field) {
                          ...
                          throw new Error("Failed pattern match at Lynx.Page.Form (line 208, column 11 - line 214, column 34): " + [ field.input.constructor.name ]);
                      });
                  }))(function () {
                  ...
                  return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                      ...
                      $50.form = Data_Functor.map(Network_RemoteData.functorRemoteData)(function (v4) {
                          return {
                              expr: v.value0,
                              evaled: v4
                          };
      ...
      if (v instanceof UpdateKey) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
              ...
              $56.values = Data_Map_Internal.alter(Data_Ord.ordString)(function (v2) {
                  return Lynx_Data_Form.userInput(v.value1);
              })(v.value0)(state.values);
              return $56;
          }))(function () {
      ...
      if (v instanceof DropdownQuery) {
          ...
          if (v.value1 instanceof Ocelot_Component_Dropdown.Selected) {
              return $$eval(new UpdateKey(v.value0, new Lynx_Data_Form.UserInput(v.value1.value0), v.value2));
          };
      ...
      throw new Error("Failed pattern match at Lynx.Page.Form (line 192, column 8 - line 230, column 42): " + [ v.constructor.name ]);
  };
  ...
  var component = function (dictMonadAff) {
      var renderInput = function (v) {
          ...
          if (v.input instanceof Lynx_Data_Form.Dropdown) {
              return Halogen_HTML["slot'"](Halogen_Component_ChildPath.cp1)(v.key)(Ocelot_Component_Dropdown.component(dictMonadAff))({
                  ...
                  render: Ocelot_Component_Dropdown_Render.render(dictMonadAff)(Ocelot_Component_Dropdown_Render.defDropdown(Lynx_Data_Expr.eqExprType)(Ocelot_Block_Button.button)([  ])(function ($96) {
                      return Data_Foldable.foldMap(Data_Foldable.foldableMaybe)(Data_Monoid.monoidString)(function ($97) {
                          return Lynx_Data_Expr.print((function (v1) {
                              return v1.name;
                          })($97));
                      })(Lynx_Data_Expr.toPair($96));
          ...
          if (v.input instanceof Lynx_Data_Form.Toggle) {
              return Ocelot_Block_Toggle.toggle([ Halogen_HTML_Properties.checked(Data_Maybe.fromMaybe(false)(Control_Bind.bindFlipped(Data_Maybe.bindMaybe)(Lynx_Data_Expr.toBoolean)(Lynx_Data_Form.getValue(v.input.value0)))), Halogen_HTML_Properties.id_(v.key), Halogen_HTML_Events.onChecked(Halogen_HTML_Events.input(function ($98) {
                  return UpdateKey.create(v.key)(Lynx_Data_Form.UserInput.create(Lynx_Data_Expr["Boolean"].create($98)));
              })) ]);
          };
          throw new Error("Failed pattern match at Lynx.Page.Form (line 152, column 25 - line 189, column 10): " + [ v.input.constructor.name ]);
      };
      ...
      var renderEvalError = function (v) {
          ...
          throw new Error("Failed pattern match at Lynx.Page.Form (line 120, column 21 - line 132, column 33): " + [ v.constructor.name ]);
      };
      var render = function (v) {
          return Ocelot_Block_Layout.section_((function () {
              ...
              throw new Error("Failed pattern match at Lynx.Page.Form (line 105, column 7 - line 117, column 51): " + [ v.form.constructor.name ]);
          })());
      };
