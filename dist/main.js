...
(function(exports) {
  ...
  var decodeJsonMaybe = function (dictDecodeJson) {
      return new DecodeJson(function (j) {
          ...
          throw new Error("Failed pattern match at Data.Argonaut.Decode.Class line 29, column 1 - line 29, column 65: " + [ j.constructor.name ]);
      });
  };
  ...
  var decodeJObject = function ($61) {
      return Data_Maybe.maybe(new Data_Either.Left("Value is not an Object"))(Data_Either.Right.create)(Data_Argonaut_Core.toObject($61));
  };
  var decodeJArray = function ($62) {
      return Data_Maybe.maybe(new Data_Either.Left("Value is not an Array"))(Data_Either.Right.create)(Data_Argonaut_Core.toArray($62));
  };
  var decodeForeignObject = function (dictDecodeJson) {
      return new DecodeJson(function ($69) {
          ...
          })(Control_Bind.composeKleisliFlipped(Data_Either.bindEither)(Data_Traversable.traverse(Foreign_Object.traversableObject)(Data_Either.applicativeEither)(decodeJson(dictDecodeJson)))(decodeJObject)($69));
      });
  };
  var decodeArray = function (dictDecodeJson) {
      return new DecodeJson((function () {
          ...
          var f = function (i) {
              return function ($70) {
                  return Data_Bifunctor.lmap(Data_Either.bifunctorEither)(msg(i))(decodeJson(dictDecodeJson)($70));
              };
          };
          return function ($71) {
              return Data_Bifunctor.lmap(Data_Either.bifunctorEither)(function (v) {
                  return "Couldn't decode Array (" + v;
              })(Control_Bind.composeKleisliFlipped(Data_Either.bindEither)(Data_TraversableWithIndex.traverseWithIndex(Data_TraversableWithIndex.traversableWithIndexArray)(Data_Either.applicativeEither)(f))(decodeJArray)($71));
          };
      })());
  };
...
(function(exports) {
  ...
  var Expr = (function () {
      function Expr(value0) {
          this.value0 = value0;
      };
      Expr.create = function (value0) {
          return new Expr(value0);
      };
      return Expr;
  })();
  var Val = (function () {
  ...
  var If = (function () {
      function If(value0, value1, value2, value3) {
          this.value0 = value0;
          this.value1 = value1;
          this.value2 = value2;
          this.value3 = value3;
      ...
      If.create = function (value0) {
          return function (value1) {
              return function (value2) {
                  return function (value3) {
                      return new If(value0, value1, value2, value3);
                  };
              };
          };
      };
  ...
  var Equal = (function () {
      function Equal(value0, value1, value2) {
          this.value0 = value0;
          this.value1 = value1;
          this.value2 = value2;
      };
      Equal.create = function (value0) {
          return function (value1) {
              return function (value2) {
                  return new Equal(value0, value1, value2);
              };
          };
      };
      return Equal;
  ...
  var Print = (function () {
      function Print(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      Print.create = function (value0) {
          return function (value1) {
              return new Print(value0, value1);
          };
      };
      return Print;
  })();
  var Expressible = function (Eq1, Show0, print, reflectProxy, toExprType) {
      this.Eq1 = Eq1;
      this.Show0 = Show0;
      this.print = print;
      this.reflectProxy = reflectProxy;
      this.toExprType = toExprType;
  };
  var toExprType = function (dict) {
      return dict.toExprType;
  };                                                                                                                                                                                                                                                                                                       
  var runExpr = function (r) {
      return function (v) {
          return v.value0(function (dictExpressible) {
              return r(dictExpressible);
          });
      };
  };
  ...
  var mkExpr = function (dictExpressible) {
      return function (dictExpressible1) {
          return function (e) {
              return new Expr(function (v) {
                  return v(dictExpressible)(e);
              });
          };
      };
  };
  var exprVoid = new Expressible(function () {
      return Data_Eq.eqVoid;
  }, function () {
      return Data_Void.showVoid;
  }, Data_Show.show(Data_Void.showVoid), function (v) {
      return "Void";
  }, Data_Void.absurd);
  var exprString = new Expressible(function () {
      return Data_Eq.eqString;
  }, function () {
  ...
  var exprInt = new Expressible(function () {
      return Data_Eq.eqInt;
  }, function () {
      return Data_Show.showInt;
  }, Data_Show.show(Data_Show.showInt), function (v) {
      return "Int";
  }, Int.create);
  var exprBoolean = new Expressible(function () {
      return Data_Eq.eqBoolean;
  }, function () {
      return Data_Show.showBoolean;
  }, Data_Show.show(Data_Show.showBoolean), function (v) {
      return "Boolean";
  }, $$Boolean.create);
  var showExpr = function (dictExpressible) {
      return new Data_Show.Show((function () {
          var go = function (dictExpressible1) {
              return function (v) {
                  if (v instanceof Val) {
                      return "(Val _ " + (Data_Show.show(dictExpressible.Show0())(v.value1) + ")");
                  };
                  if (v instanceof If) {
                      return "(If _ " + (Data_Show.show(showExpr(exprBoolean))(v.value1) + (" " + (Data_Show.show(showExpr(dictExpressible))(v.value2) + (" " + (Data_Show.show(showExpr(dictExpressible))(v.value3) + ")")))));
                  };
                  if (v instanceof Equal) {
                      return "(Equal _ " + (Data_Show.show(showExpr(dictExpressible1))(v.value1) + (" " + (Data_Show.show(showExpr(dictExpressible1))(v.value2) + ")")));
                  };
                  if (v instanceof Print) {
                      return "(Print _ " + (Data_Show.show(showExpr(dictExpressible1))(v.value1) + ")");
                  };
                  throw new Error("Failed pattern match at Formal.Data.Expr line 102, column 7 - line 102, column 54: " + [ v.constructor.name ]);
              };
          };
          return runExpr(function (dictExpressible1) {
              return go(dictExpressible1);
          });
      })());
  }; 
  var decodeVal = function (dictDecodeJson) {
      return new Data_Argonaut_Decode_Class.DecodeJson(function (json) {
          return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Class.decodeJson(Data_Argonaut_Decode_Class.decodeForeignObject(Data_Argonaut_Decode_Class.decodeJsonJson))(json))(function (v) {
              return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(dictDecodeJson)(v)("param"))(function ($170) {
                  return Control_Applicative.pure(Data_Either.applicativeEither)(Val.create(Control_Category.identity(Data_Leibniz.categoryLeibniz))($170));
              });
          });
      });
  };
  var decodeExprFOther = new Data_Argonaut_Decode_Class.DecodeJson(function (v) {
      return new Data_Either.Left("Unimplemented");
  });
  var decodeEqualF = function (dictDecodeJson) {
      return function (v) {
          if (v.length === 2) {
              return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Class.decodeJson(dictDecodeJson)(v[0]))(function (v1) {
                  return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Class.decodeJson(dictDecodeJson)(v[1]))(function (v2) {
                      return Control_Applicative.pure(Data_Either.applicativeEither)(new Equal(Control_Category.identity(Data_Leibniz.categoryLeibniz), v1, v2));
                  });
              });
          };
  ...
  var decodeExprFIBoolean = function (dictDecodeJson) {
      return new Data_Argonaut_Decode_Class.DecodeJson(function (json) {
          return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Class.decodeJson(Data_Argonaut_Decode_Class.decodeForeignObject(Data_Argonaut_Decode_Class.decodeJsonJson))(json))(function (v) {
              return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(Data_Argonaut_Decode_Class.decodeArray(Data_Argonaut_Decode_Class.decodeJsonJson))(v)("params"))(function (v1) {
                  return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(Data_Argonaut_Decode_Class.decodeJsonString)(v)("op"))(function (v2) {
                      if (v2 === "Equal") {
                          return decodeEqualF(dictDecodeJson)(v1);
                      };
                      return Data_Either.Left.create(v2 + " invalid op");
                  });
              });
          });
      });
  };
  var decodeIfF = function (dictDecodeJson) {
      return function (v) {
          if (v.length === 3) {
              return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Class.decodeJson(decodeExprBoolean)(v[0]))(function (v1) {
                  return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Class.decodeJson(dictDecodeJson)(v[1]))(function (v2) {
                      return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Class.decodeJson(dictDecodeJson)(v[2]))(function (v3) {
                          return Control_Applicative.pure(Data_Either.applicativeEither)(new If(Control_Category.identity(Data_Leibniz.categoryLeibniz), v1, v2, v3));
                      });
                  });
              });
          };
          return new Data_Either.Left("Expceted 3 params");
      };
  };
  var decodeExprString = new Data_Argonaut_Decode_Class.DecodeJson(function (json) {
      return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Class.decodeJson(Data_Argonaut_Decode_Class.decodeForeignObject(Data_Argonaut_Decode_Class.decodeJsonJson))(json))(function (v) {
          return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(Data_Argonaut_Decode_Class.decodeJsonString)(v)("in"))(function (v1) {
              if (v1 === "Boolean") {
                  return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Class.decodeJson(decodeExprFBooleanO(decodeExprString))(json))(function (v2) {
                      return Control_Applicative.pure(Data_Either.applicativeEither)(mkExpr(exprBoolean)(exprString)(v2));
                  });
              };
              if (v1 === "Int") {
                  return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Class.decodeJson(decodeExprFOther)(json))(function (v2) {
                      return Control_Applicative.pure(Data_Either.applicativeEither)(mkExpr(exprInt)(exprString)(v2));
                  });
              };
              if (v1 === "String") {
                  return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Class.decodeJson(decodeExprFOther)(json))(function (v2) {
                      return Control_Applicative.pure(Data_Either.applicativeEither)(mkExpr(exprString)(exprString)(v2));
                  });
              };
              if (v1 === "Void") {
                  return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Class.decodeJson(decodeVal(Data_Argonaut_Decode_Class.decodeJsonString))(json))(function (v2) {
                      return Control_Applicative.pure(Data_Either.applicativeEither)(mkExpr(exprVoid)(exprString)(v2));
                  });
              };
              return Data_Either.Left.create(v1 + " not implemented");
          });
      });
  });
  var decodeExprInt = new Data_Argonaut_Decode_Class.DecodeJson(function (json) {
      return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Class.decodeJson(Data_Argonaut_Decode_Class.decodeForeignObject(Data_Argonaut_Decode_Class.decodeJsonJson))(json))(function (v) {
          return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(Data_Argonaut_Decode_Class.decodeJsonString)(v)("in"))(function (v1) {
              if (v1 === "Boolean") {
                  return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Class.decodeJson(decodeExprFBooleanO(decodeExprInt))(json))(function (v2) {
                      return Control_Applicative.pure(Data_Either.applicativeEither)(mkExpr(exprBoolean)(exprInt)(v2));
                  });
              };
              if (v1 === "Int") {
                  return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Class.decodeJson(decodeExprFOther)(json))(function (v2) {
                      return Control_Applicative.pure(Data_Either.applicativeEither)(mkExpr(exprInt)(exprInt)(v2));
                  });
              };
              if (v1 === "String") {
                  return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Class.decodeJson(decodeExprFOther)(json))(function (v2) {
                      return Control_Applicative.pure(Data_Either.applicativeEither)(mkExpr(exprString)(exprInt)(v2));
                  });
              };
              if (v1 === "Void") {
                  return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Class.decodeJson(decodeVal(Data_Argonaut_Decode_Class.decodeJsonInt))(json))(function (v2) {
                      return Control_Applicative.pure(Data_Either.applicativeEither)(mkExpr(exprVoid)(exprInt)(v2));
                  });
              };
              return Data_Either.Left.create(v1 + " not implemented");
          });
  ...
  var decodeExprFBooleanO = function (dictDecodeJson) {
      return new Data_Argonaut_Decode_Class.DecodeJson(function (json) {
          return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Class.decodeJson(Data_Argonaut_Decode_Class.decodeForeignObject(Data_Argonaut_Decode_Class.decodeJsonJson))(json))(function (v) {
              return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(Data_Argonaut_Decode_Class.decodeArray(Data_Argonaut_Decode_Class.decodeJsonJson))(v)("params"))(function (v1) {
                  return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(Data_Argonaut_Decode_Class.decodeJsonString)(v)("op"))(function (v2) {
                      if (v2 === "If") {
                          return decodeIfF(dictDecodeJson)(v1);
                      };
                      return Data_Either.Left.create(v2 + " invalid op");
                  });
              });
  ...
  var decodeExprFBooleanBoolean = new Data_Argonaut_Decode_Class.DecodeJson(function (json) {
      return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Class.decodeJson(Data_Argonaut_Decode_Class.decodeForeignObject(Data_Argonaut_Decode_Class.decodeJsonJson))(json))(function (v) {
          return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(Data_Argonaut_Decode_Class.decodeArray(Data_Argonaut_Decode_Class.decodeJsonJson))(v)("params"))(function (v1) {
              return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(Data_Argonaut_Decode_Class.decodeJsonString)(v)("op"))(function (v2) {
                  if (v2 === "If") {
                      return decodeIfF(decodeExprBoolean)(v1);
                  };
                  if (v2 === "Equal") {
                      return decodeEqualF(decodeExprBoolean)(v1);
                  };
                  return Data_Either.Left.create(v2 + " invald op");
              });
          });
      });
  });
  var decodeExprBoolean = new Data_Argonaut_Decode_Class.DecodeJson(function (json) {
      return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Class.decodeJson(Data_Argonaut_Decode_Class.decodeForeignObject(Data_Argonaut_Decode_Class.decodeJsonJson))(json))(function (v) {
          return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(Data_Argonaut_Decode_Class.decodeJsonString)(v)("in"))(function (v1) {
              if (v1 === "Boolean") {
                  return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Class.decodeJson(decodeExprFBooleanBoolean)(json))(function (v2) {
                      return Control_Applicative.pure(Data_Either.applicativeEither)(mkExpr(exprBoolean)(exprBoolean)(v2));
                  });
              };
              if (v1 === "Int") {
                  return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Class.decodeJson(decodeExprFIBoolean(decodeExprInt))(json))(function (v2) {
                      return Control_Applicative.pure(Data_Either.applicativeEither)(mkExpr(exprInt)(exprBoolean)(v2));
                  });
              };
              if (v1 === "String") {
                  return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Class.decodeJson(decodeExprFIBoolean(decodeExprString))(json))(function (v2) {
                      return Control_Applicative.pure(Data_Either.applicativeEither)(mkExpr(exprString)(exprBoolean)(v2));
                  });
              };
              if (v1 === "Void") {
                  return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Class.decodeJson(decodeVal(Data_Argonaut_Decode_Class.decodeJsonBoolean))(json))(function (v2) {
                      return Control_Applicative.pure(Data_Either.applicativeEither)(mkExpr(exprVoid)(exprBoolean)(v2));
                  });
              };
              return Data_Either.Left.create(v1 + " not implemented");
          });
  ...
  exports["print"] = print;
  exports["reflectProxy"] = reflectProxy;
  exports["toExprType"] = toExprType;
  exports["Int"] = Int;
  exports["Expressible"] = Expressible;
  exports["Val"] = Val;
  exports["If"] = If;
  exports["Equal"] = Equal;
  exports["Print"] = Print;
  ...
  exports["decodeIfF"] = decodeIfF;
  exports["decodeEqualF"] = decodeEqualF;
  exports["exprBoolean"] = exprBoolean;
  exports["exprInt"] = exprInt;
  exports["exprString"] = exprString;
  exports["exprVoid"] = exprVoid;
  exports["showExpr"] = showExpr;
  exports["decodeExprBoolean"] = decodeExprBoolean;
  exports["decodeExprInt"] = decodeExprInt;
  exports["decodeExprString"] = decodeExprString;
  exports["decodeVal"] = decodeVal;
  exports["decodeExprFBooleanBoolean"] = decodeExprFBooleanBoolean;
  exports["decodeExprFIBoolean"] = decodeExprFIBoolean;
  exports["decodeExprFBooleanO"] = decodeExprFBooleanO;
  exports["decodeExprFOther"] = decodeExprFOther;
})(PS["Formal.Data.Expr"] = PS["Formal.Data.Expr"] || {});
(function(exports) {
    "use strict";
  var Control_Applicative = PS["Control.Applicative"];
  var Control_Bind = PS["Control.Bind"];
  ...
  var Data_Show = PS["Data.Show"];
  var Data_Symbol = PS["Data.Symbol"];
  var Formal_Data_Expr = PS["Formal.Data.Expr"];
  var Prelude = PS["Prelude"];
  var Type_Row = PS["Type.Row"];                 
  var Text = (function () {
  ...
  var val = function (dictShow) {
      return function (x) {
          return function (o) {
              return "\x0a  { \"op\": \"Val\", \"param\": " + (Data_Show.show(dictShow)(x) + (", \"in\": \"Void\", \"out\": " + (Data_Show.show(Data_Show.showString)(o) + " }\x0a")));
          };
      };
  };
  var toggleInput = "\x0a  { \"type\": \"Toggle\"\x0a  , \"default\": " + (val(Data_Show.showBoolean)(false)("Boolean") + "\x0a  }\x0a");
  var textInput = "\x0a  { \"type\": \"Text\"\x0a  , \"required\": " + (val(Data_Show.showBoolean)(true)("Boolean") + ("\x0a  , \"placeholder\": " + (val(Data_Show.showString)("")("String") + "\x0a  , \"default\": null\x0a  , \"maxLength\": null\x0a  , \"minLength\": null\x0a  }\x0a")));
  var testForm = function (n) {
      return function (d) {
          return function (i) {
              return "\x0a  { \"name\": " + (val(Data_Show.showString)(n)("String") + ("\x0a  , \"visibility\": " + (val(Data_Show.showBoolean)(true)("Boolean") + ("\x0a  , \"description\": " + (val(Data_Show.showString)(d)("String") + ("\x0a  , \"key\": \"firstName\"\x0a  , \"input\": " + (i + "\x0a  }\x0a")))))));
          };
      };
  };
  ...
  var newtypePage = new Data_Newtype.Newtype(function (n) {
      return n;
  }, Page);
  var newtypeForm = new Data_Newtype.Newtype(function (n) {
      return n;
  }, Form);
  var lastName = testForm("Last Name")("Enter your last name")(textInput);
  var firstName = testForm("First Name")("Enter your first name")(textInput);
  var decodeInput = new Data_Argonaut_Decode_Class.DecodeJson(function (json) {
      return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Class.decodeJson(Data_Argonaut_Decode_Class.decodeForeignObject(Data_Argonaut_Decode_Class.decodeJsonJson))(json))(function (v) {
          return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(Data_Argonaut_Decode_Class.decodeJsonString)(v)("type"))(function (v1) {
              if (v1 === "Text") {
                  return Control_Bind.composeKleisliFlipped(Data_Either.bindEither)(function ($42) {
                      return Control_Applicative.pure(Data_Either.applicativeEither)(Text.create($42));
                  })(Data_Argonaut_Decode_Class.decodeJson(Data_Argonaut_Decode_Class.decodeRecord(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeJsonMaybe(Formal_Data_Expr.decodeExprString))(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeJsonMaybe(Formal_Data_Expr.decodeExprInt))(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeJsonMaybe(Formal_Data_Expr.decodeExprInt))(Data_Argonaut_Decode_Class.gDecodeJsonCons(Formal_Data_Expr.decodeExprString)(Data_Argonaut_Decode_Class.gDecodeJsonCons(Formal_Data_Expr.decodeExprBoolean)(Data_Argonaut_Decode_Class.gDecodeJsonNil)(new Data_Symbol.IsSymbol(function () {
                      return "required";
              ...
              if (v1 === "Toggle") {
                  return Control_Bind.composeKleisliFlipped(Data_Either.bindEither)(function ($43) {
                      return Control_Applicative.pure(Data_Either.applicativeEither)(Toggle.create($43));
                  })(Data_Argonaut_Decode_Class.decodeJson(Data_Argonaut_Decode_Class.decodeRecord(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeJsonMaybe(Formal_Data_Expr.decodeExprBoolean))(Data_Argonaut_Decode_Class.gDecodeJsonNil)(new Data_Symbol.IsSymbol(function () {
                      return "default";
                  }))()())()))(json);
              };
  ...
  var decodeForm = new Data_Argonaut_Decode_Class.DecodeJson(Control_Bind.composeKleisliFlipped(Data_Either.bindEither)(function ($44) {
      return Control_Applicative.pure(Data_Either.applicativeEither)(Data_Newtype.wrap(newtypeForm)($44));
  })(Data_Argonaut_Decode_Class.decodeJson(Data_Argonaut_Decode_Class.decodeRecord(Data_Argonaut_Decode_Class.gDecodeJsonCons(Formal_Data_Expr.decodeExprString)(Data_Argonaut_Decode_Class.gDecodeJsonCons(decodeInput)(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeJsonString)(Data_Argonaut_Decode_Class.gDecodeJsonCons(Formal_Data_Expr.decodeExprString)(Data_Argonaut_Decode_Class.gDecodeJsonCons(Formal_Data_Expr.decodeExprBoolean)(Data_Argonaut_Decode_Class.gDecodeJsonNil)(new Data_Symbol.IsSymbol(function () {
      return "visibility";
  }))()())(new Data_Symbol.IsSymbol(function () {
      return "name";
  }))()())(new Data_Symbol.IsSymbol(function () {
  ...
  var decodeSection = new Data_Argonaut_Decode_Class.DecodeJson(Control_Bind.composeKleisliFlipped(Data_Either.bindEither)(function ($45) {
      return Control_Applicative.pure(Data_Either.applicativeEither)(Data_Newtype.wrap(newtypeSection)($45));
  })(Data_Argonaut_Decode_Class.decodeJson(Data_Argonaut_Decode_Class.decodeRecord(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeArray(decodeForm))(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeJsonString)(Data_Argonaut_Decode_Class.gDecodeJsonNil)(new Data_Symbol.IsSymbol(function () {
      return "name";
  }))()())(new Data_Symbol.IsSymbol(function () {
      return "contents";
  }))()())())));
  var decodePage = new Data_Argonaut_Decode_Class.DecodeJson(Control_Bind.composeKleisliFlipped(Data_Either.bindEither)(function ($46) {
      return Control_Applicative.pure(Data_Either.applicativeEither)(Data_Newtype.wrap(newtypePage)($46));
  })(Data_Argonaut_Decode_Class.decodeJson(Data_Argonaut_Decode_Class.decodeRecord(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeArray(decodeSection))(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeJsonString)(Data_Argonaut_Decode_Class.gDecodeJsonNil)(new Data_Symbol.IsSymbol(function () {
      return "name";
  }))()())(new Data_Symbol.IsSymbol(function () {
      return "contents";
  }))()())())));
  var active = testForm("Active")("Is user's account active")(toggleInput);
  var testSection = "\x0a  { \"name\": \"Name\"\x0a  , \"contents\":\x0a    [ " + (firstName + ("\x0a    , " + (lastName + ("\x0a    , " + (active + "\x0a    ]\x0a  }\x0a")))));
  var testPageJson = "\x0a  { \"name\": \"Profile\"\x0a  , \"contents\":\x0a    [ " + (testSection + "\x0a    ]\x0a  }\x0a");

  // Test
  var testPageEither = Control_Bind.bindFlipped(Data_Either.bindEither)(Data_Argonaut_Decode_Class.decodeJson(decodePage))(Data_Argonaut_Parser.jsonParser(testPageJson));
  exports["Page"] = Page;
  exports["Section"] = Section;
  exports["Form"] = Form;
  exports["Text"] = Text;
  exports["Toggle"] = Toggle;
  exports["testPageEither"] = testPageEither;
  exports["testPageJson"] = testPageJson;
  ...
  exports["val"] = val;
  exports["newtypePage"] = newtypePage;
...
})(PS["Formal.Data.Behavior"] = PS["Formal.Data.Behavior"] || {});
(function(exports) {
  // Generated by purs version 0.12.0
  "use strict";
  var Data_Eq = PS["Data.Eq"];
...
(function(exports) {
  ...
  var Data_Semigroup = PS["Data.Semigroup"];
  var Data_Show = PS["Data.Show"];
  var Formal_Data_Behavior = PS["Formal.Data.Behavior"];
  var Formal_Data_Expr = PS["Formal.Data.Expr"];
  ...
  var component = (function () {
      var renderInput = function (v) {
          if (v.input instanceof Formal_Data_Behavior.Text) {
              return Ocelot_Block_Input.input([ Halogen_HTML_Properties.placeholder(Data_Show.show(Formal_Data_Expr.showExpr(Formal_Data_Expr.exprString))(v.input.value0.placeholder)), Halogen_HTML_Properties.id_(Data_Show.show(Data_Show.showString)(v.key)) ]);
          };
          if (v.input instanceof Formal_Data_Behavior.Toggle) {
              return Ocelot_Block_Toggle.toggle([ Halogen_HTML_Properties.checked(true), Halogen_HTML_Properties.id_(Data_Show.show(Data_Show.showString)(v.key)) ]);
          };
          throw new Error("Failed pattern match at Formal.Page.Form line 80, column 29 - line 90, column 9: " + [ v.input.constructor.name ]);
      };
      var renderForm = function (v) {
          return Ocelot_Block_FormField.field_({
              label: Halogen_HTML_Core.text(Data_Show.show(Formal_Data_Expr.showExpr(Formal_Data_Expr.exprString))(v.name)),
              helpText: Data_Maybe.Just.create(Data_Show.show(Formal_Data_Expr.showExpr(Formal_Data_Expr.exprString))(v.description)),
              error: Data_Maybe.Nothing.value,
              inputId: v.key
          })([ renderInput(v) ]);
      };
      var renderSection = function (v) {
          return Ocelot_Block_Card.card_(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Ocelot_Block_Format.subHeading_([ Halogen_HTML_Core.text(v.name) ]) ])(Data_Functor.map(Data_Functor.functorArray)(renderForm)(v.contents)));
      };
      var render = function (v) {
          return Ocelot_Block_Layout.section_((function () {
              if (v.form instanceof Data_Either.Left) {
                  return [ Ocelot_Block_Card.card_([ Ocelot_Block_Format.p([ Ocelot_HTML_Properties.css("text-red") ])([ Halogen_HTML_Core.text(v.form.value0) ]) ]) ];
              };
              if (v.form instanceof Data_Either.Right) {
                  return Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Ocelot_Block_Format.heading_([ Halogen_HTML_Core.text(v.form.value0.name) ]) ])(Data_Functor.map(Data_Functor.functorArray)(renderSection)(v.form.value0.contents));
              };
              throw new Error("Failed pattern match at Formal.Page.Form line 52, column 7 - line 60, column 44: " + [ v.form.constructor.name ]);
          })());
      };
      var initialState = function (s) {
          return {
              form: Formal_Data_Behavior.testPageEither
          };
      };
      var $$eval = function (v) {
  ...
  exports["component"] = component;
})(PS["Formal.Page.Form"] = PS["Formal.Page.Form"] || {});
(function(exports) {
...
(function(exports) {
  ...
  var genericRoute = new Data_Generic_Rep.Generic(function (x) {
      ...
      throw new Error("Failed pattern match at Formal.Route line 15, column 8 - line 15, column 48: " + [ x.constructor.name ]);
  }, function (x) {
...
})(PS["Formal.Route"] = PS["Formal.Route"] || {});
(function(exports) {
    "use strict";
  var Control_Semigroupoid = PS["Control.Semigroupoid"];
  var Data_Semigroup = PS["Data.Semigroup"];
  var Formal_Route = PS["Formal.Route"];
  var Halogen = PS["Halogen"];
  var Halogen_HTML_Properties = PS["Halogen.HTML.Properties"];
  var Prelude = PS["Prelude"];
  var Routing_Duplex = PS["Routing.Duplex"];                 
  var safeHref = function ($0) {
      return Halogen_HTML_Properties.href("#" + Routing_Duplex.print(Formal_Route.routeCodec)($0));
  };
  exports["safeHref"] = safeHref;
})(PS["Formal.Util.HTML"] = PS["Formal.Util.HTML"] || {});
(function(exports) {
  // Generated by purs version 0.12.0
  "use strict";
  var DOM_HTML_Indexed = PS["DOM.HTML.Indexed"];
...
(function(exports) {
  ...
  var Data_Unit = PS["Data.Unit"];
  var Formal_Route = PS["Formal.Route"];
  var Formal_Util_HTML = PS["Formal.Util.HTML"];
  var Halogen = PS["Halogen"];
  var Halogen_Component = PS["Halogen.Component"];
  var Halogen_HTML = PS["Halogen.HTML"];
  var Halogen_HTML_Core = PS["Halogen.HTML.Core"];
  ...
  var component = (function () {
      var renderRow = function (v) {
          return Ocelot_Block_Table.row_([ Ocelot_Block_Table.cell_([ Halogen_HTML_Elements.a([ Formal_Util_HTML.safeHref(new Formal_Route.Form(v.id)) ])([ Halogen_HTML_Core.text(v.name) ]) ]) ]);
      };
      var render = function (v) {
  ...
  exports["forms"] = forms;
  exports["component"] = component;
})(PS["Formal.Page.Home"] = PS["Formal.Page.Home"] || {});
(function(exports) {
  // Generated by purs version 0.12.0
  "use strict";
  var Control_Applicative = PS["Control.Applicative"];
  ...
  var Data_Void = PS["Data.Void"];
  var Effect_Aff_Class = PS["Effect.Aff.Class"];
  var Formal_Page_Form = PS["Formal.Page.Form"];
  var Formal_Page_Home = PS["Formal.Page.Home"];
  var Formal_Route = PS["Formal.Route"];
  var Halogen = PS["Halogen"];
  var Halogen_Component = PS["Halogen.Component"];
  var Halogen_Component_ChildPath = PS["Halogen.Component.ChildPath"];
  ...
  var component = function (dictMonadAff) {
      var render = function (v) {
          if (v instanceof Formal_Route.Home) {
              return Halogen_HTML["slot'"](Halogen_Component_ChildPath.cp1)(Data_Unit.unit)(Formal_Page_Home.component)(Data_Unit.unit)(Data_Void.absurd);
          };
          if (v instanceof Formal_Route.Form) {
              return Halogen_HTML["slot'"](Halogen_Component_ChildPath.cp2)(Data_Unit.unit)(Formal_Page_Form.component)(v.value0)(Data_Void.absurd);
          };
          throw new Error("Failed pattern match at Formal.Component.Router line 49, column 12 - line 51, column 53: " + [ v.constructor.name ]);
      };
      var $$eval = function (v) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Applicative.when(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Eq.notEq(Formal_Route.eqRoute)(v1)(v.value0))(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)(v.value0)))(function () {
      ...
      return Halogen_Component.parentComponent(Data_Either.ordEither(Data_Ord.ordUnit)(Data_Either.ordEither(Data_Ord.ordUnit)(Data_Ord.ordVoid)))({
          initialState: Data_Function["const"](Formal_Route.Home.value),
          "eval": $$eval,
          render: render,
          receiver: Data_Function["const"](Data_Maybe.Nothing.value)
      });
  ...
  exports["component"] = component;
})(PS["Formal.Component.Router"] = PS["Formal.Component.Router"] || {});
(function(exports) {
  // Generated by purs version 0.12.0
  "use strict";
  var Control_Applicative = PS["Control.Applicative"];
...
(function(exports) {
  ...
  var Effect_Aff = PS["Effect.Aff"];
  var Effect_Class = PS["Effect.Class"];
  var Formal_AppM = PS["Formal.AppM"];
  var Formal_Component_Router = PS["Formal.Component.Router"];
  var Formal_Route = PS["Formal.Route"];
  var Halogen = PS["Halogen"];
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (v) {
      var router = Halogen_Component.hoist(Halogen_HTML_Core.bifunctorHTML)(Effect_Aff.functorAff)(Formal_AppM.runAppM({}))(Formal_Component_Router.component(Formal_AppM.monadAffAppM));
      return Control_Bind.bind(Effect_Aff.bindAff)(Halogen_VDom_Driver.runUI(router)(Data_Unit.unit)(v))(function (v1) {
          return Data_Functor["void"](Effect_Aff.functorAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Routing_Hash.matchesWith(Data_Either.foldableEither)(Routing_Duplex.parse(Formal_Route.routeCodec))(function (old) {
              return function ($$new) {
                  return Control_Applicative.when(Effect.applicativeEffect)(Data_Eq.notEq(Data_Maybe.eqMaybe(Formal_Route.eqRoute))(old)(new Data_Maybe.Just($$new)))(Effect_Aff.launchAff_(v1.query(new Formal_Component_Router.Navigate($$new, Data_Unit.unit))));
              };
          })));
      });
  }));
