...
(function(exports) {
  ...
  var printF = Data_Functor_Coproduct.coproduct(printArrayF)(Data_Functor_Coproduct.coproduct(printBooleanF)(Data_Functor_Coproduct.coproduct(printCentsF)(Data_Functor_Coproduct.coproduct(printIntF)(Data_Functor_Coproduct.coproduct(printPairF)(printStringF)))));
  ...
  var recursiveExprTypeExprTypeF = new Matryoshka_Class_Recursive.Recursive(function () {
      return Data_Functor_Coproduct.functorCoproduct(functorArrayF)(Data_Functor_Coproduct.functorCoproduct(functorBooleanF)(Data_Functor_Coproduct.functorCoproduct(functorCentsF)(Data_Functor_Coproduct.functorCoproduct(functorIntF)(Data_Functor_Coproduct.functorCoproduct(functorPairF)(functorStringF)))));
  }, function (v) {
      return Data_Functor.map(Data_Functor_Coproduct.functorCoproduct(functorArrayF)(Data_Functor_Coproduct.functorCoproduct(functorBooleanF)(Data_Functor_Coproduct.functorCoproduct(functorCentsF)(Data_Functor_Coproduct.functorCoproduct(functorIntF)(Data_Functor_Coproduct.functorCoproduct(functorPairF)(functorStringF))))))(ExprType)(Matryoshka_Class_Recursive.project(Matryoshka_Class_Recursive.recursiveMu(Data_Functor_Coproduct.functorCoproduct(functorArrayF)(Data_Functor_Coproduct.functorCoproduct(functorBooleanF)(Data_Functor_Coproduct.functorCoproduct(functorCentsF)(Data_Functor_Coproduct.functorCoproduct(functorIntF)(Data_Functor_Coproduct.functorCoproduct(functorPairF)(functorStringF)))))))(v));
  });
  ...
  var toString = function (x$prime) {
      return Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Functor_Coproduct_Inject.prj(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectReflexive))))))(Matryoshka_Class_Recursive.project(recursiveExprTypeExprTypeF)(x$prime)))(function (v) {
          return Control_Applicative.pure(Data_Maybe.applicativeMaybe)(v.value0);
      });
  }; 
  var eqStringF = function (dictEq) {
      return new Data_Eq.Eq(function (x) {
          return function (y) {
  ...
  var eqBooleanF = function (dictEq) {
      return new Data_Eq.Eq(function (x) {
          return function (y) {
              return x.value0 === y.value0;
          };
  ...
  var eq1StringF = new Data_Eq.Eq1(function (dictEq) {
      return Data_Eq.eq(eqStringF(dictEq));
  });
  var eq1PairF = new Data_Eq.Eq1(function (dictEq) {
      return Data_Eq.eq(eqPairF(dictEq));
  });
  var eq1IntF = new Data_Eq.Eq1(function (dictEq) {
      return Data_Eq.eq(eqIntF(dictEq));
  });
  var eq1CentsF = new Data_Eq.Eq1(function (dictEq) {
      return Data_Eq.eq(eqCentsF(dictEq));
  });
  var eq1BooleanF = new Data_Eq.Eq1(function (dictEq) {
      return Data_Eq.eq(eqBooleanF(dictEq));
  });
  var eq1ArrayF = new Data_Eq.Eq1(function (dictEq) {
      return Data_Eq.eq(eqArrayF(dictEq));
  });
  var eqExprType = Data_Functor_Mu.eqMu(Data_Functor_Coproduct.eq1Coproduct(eq1ArrayF)(Data_Functor_Coproduct.eq1Coproduct(eq1BooleanF)(Data_Functor_Coproduct.eq1Coproduct(eq1CentsF)(Data_Functor_Coproduct.eq1Coproduct(eq1IntF)(Data_Functor_Coproduct.eq1Coproduct(eq1PairF)(eq1StringF))))));
  var corecursiveExprTypeExprTypeF = new Matryoshka_Class_Corecursive.Corecursive(function () {
      return Data_Functor_Coproduct.functorCoproduct(functorArrayF)(Data_Functor_Coproduct.functorCoproduct(functorBooleanF)(Data_Functor_Coproduct.functorCoproduct(functorCentsF)(Data_Functor_Coproduct.functorCoproduct(functorIntF)(Data_Functor_Coproduct.functorCoproduct(functorPairF)(functorStringF)))));
  }, function (x) {
      return Matryoshka_Class_Corecursive.embed(Matryoshka_Class_Corecursive.corecursiveMu(Data_Functor_Coproduct.functorCoproduct(functorArrayF)(Data_Functor_Coproduct.functorCoproduct(functorBooleanF)(Data_Functor_Coproduct.functorCoproduct(functorCentsF)(Data_Functor_Coproduct.functorCoproduct(functorIntF)(Data_Functor_Coproduct.functorCoproduct(functorPairF)(functorStringF)))))))(Data_Functor.map(Data_Functor_Coproduct.functorCoproduct(functorArrayF)(Data_Functor_Coproduct.functorCoproduct(functorBooleanF)(Data_Functor_Coproduct.functorCoproduct(functorCentsF)(Data_Functor_Coproduct.functorCoproduct(functorIntF)(Data_Functor_Coproduct.functorCoproduct(functorPairF)(functorStringF))))))(Data_Newtype.un(newtypeExprType)(ExprType))(x));
  });
  var pair_ = function ($305) {
      return Matryoshka_Class_Corecursive.embed(corecursiveExprTypeExprTypeF)(Data_Functor_Coproduct_Inject.inj(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectLeft)))))(Pair.create($305)));
  };
  var string_ = function ($306) {
      return Matryoshka_Class_Corecursive.embed(corecursiveExprTypeExprTypeF)(Data_Functor_Coproduct_Inject.inj(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectReflexive))))))($$String.create($306)));
  };
  var cents_ = function ($307) {
      return Matryoshka_Class_Corecursive.embed(corecursiveExprTypeExprTypeF)(Data_Functor_Coproduct_Inject.inj(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectLeft)))(Cents.create($307)));
  };
  var boolean_ = function ($308) {
      return Matryoshka_Class_Corecursive.embed(corecursiveExprTypeExprTypeF)(Data_Functor_Coproduct_Inject.inj(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectLeft))($$Boolean.create($308)));
  };
  ...
  var encodeExprTypeF = Data_Functor_Coproduct.coproduct(encodeArrayF)(Data_Functor_Coproduct.coproduct(encodeBooleanF)(Data_Functor_Coproduct.coproduct(encodeCentsF)(Data_Functor_Coproduct.coproduct(encodeIntF)(Data_Functor_Coproduct.coproduct(encodePairF)(encodeStringF)))));
  var reflectType = function (x) {
      return (Matryoshka_Fold.cata(recursiveExprTypeExprTypeF)(encodeExprTypeF)(x)).out;
  };
  var array_ = function ($309) {
      return Matryoshka_Class_Corecursive.embed(corecursiveExprTypeExprTypeF)(Data_Functor_Coproduct_Inject.inj(Data_Functor_Coproduct_Inject.injectLeft)($$Array.create($309)));
  };
  exports["Cents"] = Cents;
  exports["Int"] = Int;
  exports["Pair"] = Pair;
...
(function(exports) {
  ...
  var Mismatch = (function () {
      function Mismatch(value0) {
          this.value0 = value0;
      };
      Mismatch.create = function (value0) {
          return new Mismatch(value0);
      };
      return Mismatch;
  })();
  var Equal = (function () {
  ...
  var renderEvalError = function (v) {
      return "Expected both sides of equal to have the same type," + (" but they are different." + (" left: " + (Lynx_Data_ExprType.reflectType(v.value0.left) + (" right: " + Lynx_Data_ExprType.reflectType(v.value0.right)))));
  };
  ...
  var evalEqualF = (function () {
      var string = function (left) {
          return function (right) {
              return Control_Bind.bind(Data_Maybe.bindMaybe)(Lynx_Data_ExprType.toString(left))(function (v) {
                  return Control_Bind.bind(Data_Maybe.bindMaybe)(Lynx_Data_ExprType.toString(right))(function (v1) {
                      return Control_Applicative.pure(Data_Maybe.applicativeMaybe)(v === v1);
                  });
              });
          };
      };
      var $$int = function (left) {
          return function (right) {
              return Control_Bind.bind(Data_Maybe.bindMaybe)(Lynx_Data_ExprType.toInt(left))(function (v) {
                  return Control_Bind.bind(Data_Maybe.bindMaybe)(Lynx_Data_ExprType.toInt(right))(function (v1) {
                      return Control_Applicative.pure(Data_Maybe.applicativeMaybe)(v === v1);
                  });
              });
          };
      };
      var $$boolean = function (left) {
          return function (right) {
              return Control_Bind.bind(Data_Maybe.bindMaybe)(Lynx_Data_ExprType.toBoolean(left))(function (v) {
                  return Control_Bind.bind(Data_Maybe.bindMaybe)(Lynx_Data_ExprType.toBoolean(right))(function (v1) {
                      return Control_Applicative.pure(Data_Maybe.applicativeMaybe)(v === v1);
                  });
              });
          };
      };
      var result = function (left) {
          return function (right) {
              return Control_Alt.alt(Data_Maybe.altMaybe)(Control_Alt.alt(Data_Maybe.altMaybe)($$boolean(left)(right))($$int(left)(right)))(string(left)(right));
          };
      };
      return function (v) {
          var v1 = result(v.value0)(v.value1);
          if (v1 instanceof Data_Maybe.Just) {
              return Control_Applicative.pure(Data_Either.applicativeEither)(Lynx_Data_ExprType.boolean_(v1.value0));
          };
          if (v1 instanceof Data_Maybe.Nothing) {
              return new Data_Either.Left(new Mismatch({
                  left: v.value0,
                  right: v.value1
              }));
          };
          throw new Error("Failed pattern match at Lynx.Data.Equal (line 76, column 23 - line 78, column 47): " + [ v1.constructor.name ]);
      };
  })();
  exports["Equal"] = Equal;
  exports["Mismatch"] = Mismatch;
  exports["renderEvalError"] = renderEvalError;
...
})(PS["Lynx.Data.Equal"] = PS["Lynx.Data.Equal"] || {});
(function(exports) {
  // Generated by purs version 0.12.3
  "use strict";
  var Control_Applicative = PS["Control.Applicative"];
  ...
  var Condition = (function () {
      function Condition(value0) {
          this.value0 = value0;
      };
      Condition.create = function (value0) {
          return new Condition(value0);
      };
      return Condition;
  })();
  var renderEvalError = function (v) {
      return "Expected conditional to be a Boolean, but its type is: " + Lynx_Data_ExprType.reflectType(v.value0);
  };
  var if_ = function (dictCorecursive) {
      return function (dictInject) {
          return function (x) {
              return function (y) {
                  return function ($91) {
                      return Matryoshka_Class_Corecursive.embed(dictCorecursive)(Data_Functor_Coproduct_Inject.inj(dictInject)(If.create(x)(y)($91)));
                  };
              };
          };
      };
  ...
  var evalIfF = function (v) {
      return Data_Maybe["maybe'"](function (v1) {
          return new Data_Either.Left(new Condition(v.value0));
      })(Control_Applicative.pure(Data_Either.applicativeEither))(Control_Bind.bind(Data_Maybe.bindMaybe)(Lynx_Data_ExprType.toBoolean(v.value0))(function (v1) {
...
})(PS["Lynx.Data.If"] = PS["Lynx.Data.If"] || {});
(function(exports) {
  // Generated by purs version 0.12.3
  "use strict";
  var Control_Applicative = PS["Control.Applicative"];
  ...
  var lookup_ = function (dictCorecursive) {
      return function (dictInject) {
          return function (x) {
              return function ($65) {
                  return Matryoshka_Class_Corecursive.embed(dictCorecursive)(Data_Functor_Coproduct_Inject.inj(dictInject)(Lookup.create(x)($65)));
              };
          };
      };
  };
...
})(PS["Lynx.Data.Lookup"] = PS["Lynx.Data.Lookup"] || {});
(function(exports) {
  // Generated by purs version 0.12.3
  "use strict";
  var Control_Applicative = PS["Control.Applicative"];
...
})(PS["Lynx.Data.Print"] = PS["Lynx.Data.Print"] || {});
(function(exports) {
  // Generated by purs version 0.12.3
  "use strict";
  var Control_Applicative = PS["Control.Applicative"];
  ...
  var val_ = function (dictCorecursive) {
      return function (dictInject) {
          return function ($43) {
              return Matryoshka_Class_Corecursive.embed(dictCorecursive)(Data_Functor_Coproduct_Inject.inj(dictInject)(Val.create($43)));
          };
      };
  };
...
})(PS["Lynx.Data.Val"] = PS["Lynx.Data.Val"] || {});
(function(exports) {
  // Generated by purs version 0.12.3
  "use strict";
  var Control_Alt = PS["Control.Alt"];
  ...
  var Data_Bifunctor = PS["Data.Bifunctor"];
  var Data_Either = PS["Data.Either"];
  var Data_Either_Inject = PS["Data.Either.Inject"];
  var Data_Either_Nested = PS["Data.Either.Nested"];
  var Data_Eq = PS["Data.Eq"];
  var Data_EuclideanRing = PS["Data.EuclideanRing"];
  var Data_Function = PS["Data.Function"];
  ...
  var Data_Symbol = PS["Data.Symbol"];
  var Data_TacitString = PS["Data.TacitString"];
  var Lynx_Data_Equal = PS["Lynx.Data.Equal"];
  var Lynx_Data_ExprType = PS["Lynx.Data.ExprType"];
  var Lynx_Data_If = PS["Lynx.Data.If"];
  var Lynx_Data_Lookup = PS["Lynx.Data.Lookup"];
  var Lynx_Data_Print = PS["Lynx.Data.Print"];
  var Lynx_Data_Val = PS["Lynx.Data.Val"];
  var Matryoshka = PS["Matryoshka"];
  var Matryoshka_Class_Corecursive = PS["Matryoshka.Class.Corecursive"];
  var Matryoshka_Class_Recursive = PS["Matryoshka.Class.Recursive"];
  var Matryoshka_Fold = PS["Matryoshka.Fold"];
  ...
  var renderEvalError = Data_Either.either(Lynx_Data_If.renderEvalError)(Lynx_Data_Equal.renderEvalError);
  var recursiveExprValF = new Matryoshka_Class_Recursive.Recursive(function () {
      return Data_Functor_Coproduct.functorCoproduct(Lynx_Data_Val.functorValF)(Data_Functor_Coproduct.functorCoproduct(Lynx_Data_If.functorIfF)(Data_Functor_Coproduct.functorCoproduct(Lynx_Data_Equal.functorEqualF)(Data_Functor_Coproduct.functorCoproduct(Lynx_Data_Print.functorPrintF)(Lynx_Data_Lookup.functorLookupF))));
  }, function (v) {
      return Data_Functor.map(Data_Functor_Coproduct.functorCoproduct(Lynx_Data_Val.functorValF)(Data_Functor_Coproduct.functorCoproduct(Lynx_Data_If.functorIfF)(Data_Functor_Coproduct.functorCoproduct(Lynx_Data_Equal.functorEqualF)(Data_Functor_Coproduct.functorCoproduct(Lynx_Data_Print.functorPrintF)(Lynx_Data_Lookup.functorLookupF)))))(Expr)(Matryoshka_Class_Recursive.project(Matryoshka_Class_Recursive.recursiveMu(Data_Functor_Coproduct.functorCoproduct(Lynx_Data_Val.functorValF)(Data_Functor_Coproduct.functorCoproduct(Lynx_Data_If.functorIfF)(Data_Functor_Coproduct.functorCoproduct(Lynx_Data_Equal.functorEqualF)(Data_Functor_Coproduct.functorCoproduct(Lynx_Data_Print.functorPrintF)(Lynx_Data_Lookup.functorLookupF))))))(v));
  });
  var newtypeExpr = new Data_Newtype.Newtype(function (n) {
      return n;
  }, Expr);
  var evalExpr = function (get) {
      var go = Data_Functor_Coproduct.coproduct(function ($10) {
          return Control_Applicative.pure(Data_Either.applicativeEither)(Lynx_Data_Val.evalValF($10));
      })(Data_Functor_Coproduct.coproduct(function ($11) {
          return Data_Bifunctor.lmap(Data_Either.bifunctorEither)(Data_Either_Inject.inj(Data_Either_Inject.injectLeft))(Lynx_Data_If.evalIfF($11));
      })(Data_Functor_Coproduct.coproduct(function ($12) {
          return Data_Bifunctor.lmap(Data_Either.bifunctorEither)(Data_Either_Inject.inj(Data_Either_Inject.injectRight(Data_Either_Inject.injectReflexive)))(Lynx_Data_Equal.evalEqualF($12));
      })(Data_Functor_Coproduct.coproduct(function ($13) {
          return Control_Applicative.pure(Data_Either.applicativeEither)(Lynx_Data_Print.evalPrintF($13));
      })(function ($14) {
          return Control_Applicative.pure(Data_Either.applicativeEither)(Lynx_Data_Lookup.evalLookupF(get)($14));
      }))));
      return Matryoshka_Fold.cataM(recursiveExprValF)(Data_Either.monadEither)(Data_Functor_Coproduct.traversableCoproduct(Lynx_Data_Val.traversableValF)(Data_Functor_Coproduct.traversableCoproduct(Lynx_Data_If.traversableIfF)(Data_Functor_Coproduct.traversableCoproduct(Lynx_Data_Equal.traversableEqualF)(Data_Functor_Coproduct.traversableCoproduct(Lynx_Data_Print.traversablePrintF)(Lynx_Data_Lookup.traversableLookupF)))))(go);
  };                                                                         
  var corecursiveExprValF = new Matryoshka_Class_Corecursive.Corecursive(function () {
      return Data_Functor_Coproduct.functorCoproduct(Lynx_Data_Val.functorValF)(Data_Functor_Coproduct.functorCoproduct(Lynx_Data_If.functorIfF)(Data_Functor_Coproduct.functorCoproduct(Lynx_Data_Equal.functorEqualF)(Data_Functor_Coproduct.functorCoproduct(Lynx_Data_Print.functorPrintF)(Lynx_Data_Lookup.functorLookupF))));
  }, function (x) {
      return Matryoshka_Class_Corecursive.embed(Matryoshka_Class_Corecursive.corecursiveMu(Data_Functor_Coproduct.functorCoproduct(Lynx_Data_Val.functorValF)(Data_Functor_Coproduct.functorCoproduct(Lynx_Data_If.functorIfF)(Data_Functor_Coproduct.functorCoproduct(Lynx_Data_Equal.functorEqualF)(Data_Functor_Coproduct.functorCoproduct(Lynx_Data_Print.functorPrintF)(Lynx_Data_Lookup.functorLookupF))))))(Data_Functor.map(Data_Functor_Coproduct.functorCoproduct(Lynx_Data_Val.functorValF)(Data_Functor_Coproduct.functorCoproduct(Lynx_Data_If.functorIfF)(Data_Functor_Coproduct.functorCoproduct(Lynx_Data_Equal.functorEqualF)(Data_Functor_Coproduct.functorCoproduct(Lynx_Data_Print.functorPrintF)(Lynx_Data_Lookup.functorLookupF)))))(Data_Newtype.un(newtypeExpr)(Expr))(x));
  });
  var string_ = function ($16) {
      return Lynx_Data_Val.val_(corecursiveExprValF)(Data_Functor_Coproduct_Inject.injectLeft)(Lynx_Data_ExprType.string_($16));
  };
  var cents_ = function ($17) {
      return Lynx_Data_Val.val_(corecursiveExprValF)(Data_Functor_Coproduct_Inject.injectLeft)(Lynx_Data_ExprType.cents_($17));
  };
  var boolean_ = function ($18) {
      return Lynx_Data_Val.val_(corecursiveExprValF)(Data_Functor_Coproduct_Inject.injectLeft)(Lynx_Data_ExprType.boolean_($18));
  };
  exports["Expr"] = Expr;
  exports["renderEvalError"] = renderEvalError;
...
(function(exports) {
          ...
          return function (page) {
              var setField = function (field) {
                  if (key === field.key) {
                      if (field.input instanceof Currency) {
                          return {
                              ...
                              input: new Currency({
                                  ...
                                  value: new UserInput(Lynx_Data_Val.val_(Lynx_Data_Expr.corecursiveExprValF)(Data_Functor_Coproduct_Inject.injectLeft)(val)),
                      ...
                      throw new Error("Failed pattern match at Lynx.Data.Form (line 263, column 26 - line 271, column 72): " + [ field.input.constructor.name ]);
                  };
                  if (Data_Boolean.otherwise) {
                      return field;
                  };
                  throw new Error("Failed pattern match at Lynx.Data.Form (line 261, column 3 - line 261, column 39): " + [ field.constructor.name ]);
              };
  ...
  var mvpObjective = (function () {
      var options = Lynx_Data_Val.val_(Lynx_Data_Expr.corecursiveExprValF)(Data_Functor_Coproduct_Inject.injectLeft)(Lynx_Data_ExprType.array_([ Lynx_Data_ExprType.pair_({
          name: Matryoshka_Class_Corecursive.embed(Lynx_Data_ExprType.corecursiveExprTypeExprTypeF)(Data_Functor_Coproduct_Inject.inj(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectReflexive))))))(new Lynx_Data_ExprType["String"]("App Installs"))),
          value: Matryoshka_Class_Corecursive.embed(Lynx_Data_ExprType.corecursiveExprTypeExprTypeF)(Data_Functor_Coproduct_Inject.inj(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectReflexive))))))(new Lynx_Data_ExprType["String"]("App Installs")))
      }), Lynx_Data_ExprType.pair_({
          name: Matryoshka_Class_Corecursive.embed(Lynx_Data_ExprType.corecursiveExprTypeExprTypeF)(Data_Functor_Coproduct_Inject.inj(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectReflexive))))))(new Lynx_Data_ExprType["String"]("Brand Awareness"))),
          value: Matryoshka_Class_Corecursive.embed(Lynx_Data_ExprType.corecursiveExprTypeExprTypeF)(Data_Functor_Coproduct_Inject.inj(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectReflexive))))))(new Lynx_Data_ExprType["String"]("Brand Awareness")))
      }), Lynx_Data_ExprType.pair_({
          name: Matryoshka_Class_Corecursive.embed(Lynx_Data_ExprType.corecursiveExprTypeExprTypeF)(Data_Functor_Coproduct_Inject.inj(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectReflexive))))))(new Lynx_Data_ExprType["String"]("Conversions"))),
          value: Matryoshka_Class_Corecursive.embed(Lynx_Data_ExprType.corecursiveExprTypeExprTypeF)(Data_Functor_Coproduct_Inject.inj(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectReflexive))))))(new Lynx_Data_ExprType["String"]("Conversions")))
      }), Lynx_Data_ExprType.pair_({
          name: Matryoshka_Class_Corecursive.embed(Lynx_Data_ExprType.corecursiveExprTypeExprTypeF)(Data_Functor_Coproduct_Inject.inj(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectReflexive))))))(new Lynx_Data_ExprType["String"]("Event Responses"))),
          value: Matryoshka_Class_Corecursive.embed(Lynx_Data_ExprType.corecursiveExprTypeExprTypeF)(Data_Functor_Coproduct_Inject.inj(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectReflexive))))))(new Lynx_Data_ExprType["String"]("Event Responses")))
      }), Lynx_Data_ExprType.pair_({
          name: Matryoshka_Class_Corecursive.embed(Lynx_Data_ExprType.corecursiveExprTypeExprTypeF)(Data_Functor_Coproduct_Inject.inj(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectReflexive))))))(new Lynx_Data_ExprType["String"]("Lead Generation"))),
          value: Matryoshka_Class_Corecursive.embed(Lynx_Data_ExprType.corecursiveExprTypeExprTypeF)(Data_Functor_Coproduct_Inject.inj(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectReflexive))))))(new Lynx_Data_ExprType["String"]("Lead Generation")))
      }), Lynx_Data_ExprType.pair_({
          name: Matryoshka_Class_Corecursive.embed(Lynx_Data_ExprType.corecursiveExprTypeExprTypeF)(Data_Functor_Coproduct_Inject.inj(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectReflexive))))))(new Lynx_Data_ExprType["String"]("Link Clicks"))),
          value: Matryoshka_Class_Corecursive.embed(Lynx_Data_ExprType.corecursiveExprTypeExprTypeF)(Data_Functor_Coproduct_Inject.inj(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectReflexive))))))(new Lynx_Data_ExprType["String"]("Link Clicks")))
      }), Lynx_Data_ExprType.pair_({
          name: Matryoshka_Class_Corecursive.embed(Lynx_Data_ExprType.corecursiveExprTypeExprTypeF)(Data_Functor_Coproduct_Inject.inj(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectReflexive))))))(new Lynx_Data_ExprType["String"]("Offer Claims"))),
          value: Matryoshka_Class_Corecursive.embed(Lynx_Data_ExprType.corecursiveExprTypeExprTypeF)(Data_Functor_Coproduct_Inject.inj(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectReflexive))))))(new Lynx_Data_ExprType["String"]("Offer Claims")))
      }), Lynx_Data_ExprType.pair_({
          name: Matryoshka_Class_Corecursive.embed(Lynx_Data_ExprType.corecursiveExprTypeExprTypeF)(Data_Functor_Coproduct_Inject.inj(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectReflexive))))))(new Lynx_Data_ExprType["String"]("Page Likes"))),
          value: Matryoshka_Class_Corecursive.embed(Lynx_Data_ExprType.corecursiveExprTypeExprTypeF)(Data_Functor_Coproduct_Inject.inj(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectReflexive))))))(new Lynx_Data_ExprType["String"]("Page Likes")))
      }), Lynx_Data_ExprType.pair_({
          name: Matryoshka_Class_Corecursive.embed(Lynx_Data_ExprType.corecursiveExprTypeExprTypeF)(Data_Functor_Coproduct_Inject.inj(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectReflexive))))))(new Lynx_Data_ExprType["String"]("Post Engagement"))),
          value: Matryoshka_Class_Corecursive.embed(Lynx_Data_ExprType.corecursiveExprTypeExprTypeF)(Data_Functor_Coproduct_Inject.inj(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectReflexive))))))(new Lynx_Data_ExprType["String"]("Post Engagement")))
      }), Lynx_Data_ExprType.pair_({
          name: Matryoshka_Class_Corecursive.embed(Lynx_Data_ExprType.corecursiveExprTypeExprTypeF)(Data_Functor_Coproduct_Inject.inj(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectReflexive))))))(new Lynx_Data_ExprType["String"]("Reach"))),
          value: Matryoshka_Class_Corecursive.embed(Lynx_Data_ExprType.corecursiveExprTypeExprTypeF)(Data_Functor_Coproduct_Inject.inj(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectReflexive))))))(new Lynx_Data_ExprType["String"]("Reach")))
      }), Lynx_Data_ExprType.pair_({
          name: Matryoshka_Class_Corecursive.embed(Lynx_Data_ExprType.corecursiveExprTypeExprTypeF)(Data_Functor_Coproduct_Inject.inj(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectReflexive))))))(new Lynx_Data_ExprType["String"]("VideoViews"))),
          value: Matryoshka_Class_Corecursive.embed(Lynx_Data_ExprType.corecursiveExprTypeExprTypeF)(Data_Functor_Coproduct_Inject.inj(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectReflexive))))))(new Lynx_Data_ExprType["String"]("VideoViews")))
      }) ]));
      return {
  ...
  var keys = function (page) {
      var keysField = function (field) {
          var value = (function () {
              ...
              throw new Error("Failed pattern match at Lynx.Data.Form (line 243, column 13 - line 247, column 39): " + [ field.input.constructor.name ]);
          })();
          if (value instanceof Data_Maybe.Just) {
              ...
              throw new Error("Failed pattern match at Lynx.Data.Form (line 238, column 18 - line 240, column 48): " + [ v.constructor.name ]);
          };
          if (value instanceof Data_Maybe.Nothing) {
              return Data_Monoid.mempty(Data_Map_Internal.monoidMap(Data_Ord.ordString));
          };
          throw new Error("Failed pattern match at Lynx.Data.Form (line 237, column 21 - line 241, column 22): " + [ value.constructor.name ]);
      };
  ...
  var food = {
      ...
      input: new Dropdown({
          "default": Data_Maybe.Nothing.value,
          options: Lynx_Data_If.if_(Lynx_Data_Expr.corecursiveExprValF)(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectLeft))(Lynx_Data_Lookup.lookup_(Lynx_Data_Expr.corecursiveExprValF)(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectReflexive)))))("active")(Lynx_Data_Expr.boolean_(false)))(Lynx_Data_Val.val_(Lynx_Data_Expr.corecursiveExprValF)(Data_Functor_Coproduct_Inject.injectLeft)(Lynx_Data_ExprType.array_([ Lynx_Data_ExprType.pair_({
              name: Matryoshka_Class_Corecursive.embed(Lynx_Data_ExprType.corecursiveExprTypeExprTypeF)(Data_Functor_Coproduct_Inject.inj(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectReflexive))))))(new Lynx_Data_ExprType["String"]("Strawberry"))),
              value: Matryoshka_Class_Corecursive.embed(Lynx_Data_ExprType.corecursiveExprTypeExprTypeF)(Data_Functor_Coproduct_Inject.inj(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectReflexive))))))(new Lynx_Data_ExprType["String"]("Strawberry")))
          }), Lynx_Data_ExprType.pair_({
              name: Matryoshka_Class_Corecursive.embed(Lynx_Data_ExprType.corecursiveExprTypeExprTypeF)(Data_Functor_Coproduct_Inject.inj(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectReflexive))))))(new Lynx_Data_ExprType["String"]("Blueberry"))),
              value: Matryoshka_Class_Corecursive.embed(Lynx_Data_ExprType.corecursiveExprTypeExprTypeF)(Data_Functor_Coproduct_Inject.inj(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectReflexive))))))(new Lynx_Data_ExprType["String"]("Blueberry")))
          }) ])))(Lynx_Data_Val.val_(Lynx_Data_Expr.corecursiveExprValF)(Data_Functor_Coproduct_Inject.injectLeft)(Lynx_Data_ExprType.array_([ Lynx_Data_ExprType.pair_({
              name: Matryoshka_Class_Corecursive.embed(Lynx_Data_ExprType.corecursiveExprTypeExprTypeF)(Data_Functor_Coproduct_Inject.inj(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectReflexive))))))(new Lynx_Data_ExprType["String"]("Apple"))),
              value: Matryoshka_Class_Corecursive.embed(Lynx_Data_ExprType.corecursiveExprTypeExprTypeF)(Data_Functor_Coproduct_Inject.inj(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectReflexive))))))(new Lynx_Data_ExprType["String"]("Apple")))
          }), Lynx_Data_ExprType.pair_({
              name: Matryoshka_Class_Corecursive.embed(Lynx_Data_ExprType.corecursiveExprTypeExprTypeF)(Data_Functor_Coproduct_Inject.inj(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectReflexive))))))(new Lynx_Data_ExprType["String"]("Banana"))),
              value: Matryoshka_Class_Corecursive.embed(Lynx_Data_ExprType.corecursiveExprTypeExprTypeF)(Data_Functor_Coproduct_Inject.inj(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectReflexive))))))(new Lynx_Data_ExprType["String"]("Banana")))
          }), Lynx_Data_ExprType.pair_({
              name: Matryoshka_Class_Corecursive.embed(Lynx_Data_ExprType.corecursiveExprTypeExprTypeF)(Data_Functor_Coproduct_Inject.inj(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectReflexive))))))(new Lynx_Data_ExprType["String"]("Cherry"))),
              value: Matryoshka_Class_Corecursive.embed(Lynx_Data_ExprType.corecursiveExprTypeExprTypeF)(Data_Functor_Coproduct_Inject.inj(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectReflexive))))))(new Lynx_Data_ExprType["String"]("Cherry")))
          }) ]))),
          placeholder: Lynx_Data_Expr.string_(""),
          required: Lynx_Data_Expr.boolean_(true),
          value: NotSet.value
  ...
  var foldableInputSource = new Data_Foldable.Foldable(function (dictMonoid) {
      return function (f) {
          return function (v) {
              ...
              throw new Error("Failed pattern match at Lynx.Data.Form (line 120, column 15 - line 123, column 21): " + [ v.constructor.name ]);
          };
      };
  }, function (f) {
  ...
  var traversableInputSource = new Data_Traversable.Traversable(function () {
      ...
      return function (f) {
          return function (v) {
              ...
              throw new Error("Failed pattern match at Lynx.Data.Form (line 129, column 16 - line 132, column 26): " + [ v.constructor.name ]);
          };
      };
  });
  var firstName = {
  ...
  var $$eval = function (get) {
      return function (page) {
          var evalInput = function (v) {
              ...
              throw new Error("Failed pattern match at Lynx.Data.Form (line 179, column 15 - line 228, column 39): " + [ v.constructor.name ]);
          };
  ...
  var active = (function () {
      var description = Lynx_Data_If.if_(Lynx_Data_Expr.corecursiveExprValF)(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectLeft))(Lynx_Data_Lookup.lookup_(Lynx_Data_Expr.corecursiveExprValF)(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectRight(Data_Functor_Coproduct_Inject.injectReflexive)))))("active")(Lynx_Data_Expr.boolean_(true)))(Lynx_Data_Expr.string_("User's account is active!"))(Lynx_Data_Expr.string_("User's account is not active"));
      return {
...
(function(exports) {
  ...
  var genericRoute = new Data_Generic_Rep.Generic(function (x) {
      ...
      throw new Error("Failed pattern match at Lynx.Page.Form (line 46, column 8 - line 46, column 48): " + [ x.constructor.name ]);
  }, function (x) {
  ...
  var $$eval = function (v) {
      if (v instanceof Initialize) {
          return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value0)(Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)((function () {
                  ...
                  throw new Error("Failed pattern match at Lynx.Page.Form (line 184, column 14 - line 186, column 42): " + [ v1.route.constructor.name ]);
              })())(function (v2) {
                  return Data_Bifoldable.bifor_(Network_RemoteData.bifoldableRemoteData)(Halogen_Query_HalogenM.applicativeHalogenM)(v2)(function (e) {
                      return Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                          ...
                          $33.form = new Network_RemoteData.Failure(e);
                          return $33;
                      });
                  })(function (page) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                          ...
                          $36.values = Lynx_Data_Form.keys(page);
                          return $36;
                      }))(function () {
              ...
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Data_Traversable["for"](Halogen_Query_HalogenM.applicativeHalogenM)(Data_Either.traversableEither)(evaled$prime)(function (page) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Data_Foldable.for_(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Foldable.foldableArray)(page.contents)(function (section) {
                      return Data_Foldable.for_(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Foldable.foldableArray)(section.contents)(function (field) {
                          ...
                          throw new Error("Failed pattern match at Lynx.Page.Form (line 197, column 11 - line 203, column 34): " + [ field.input.constructor.name ]);
                      });
                  }))(function () {
                  ...
                  return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                      ...
                      $48.form = Data_Functor.map(Network_RemoteData.functorRemoteData)(function (v4) {
                          return {
                              expr: v.value0,
                              evaled: v4
                          };
      ...
      if (v instanceof UpdateKey) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
              ...
              $54.values = Data_Map_Internal.insert(Data_Ord.ordString)(v.value0)(v.value1)(state.values);
              return $54;
          }))(function () {
      ...
      if (v instanceof DropdownQuery) {
          ...
          throw new Error("Failed pattern match at Lynx.Page.Form (line 215, column 34 - line 218, column 42): " + [ v.value1.constructor.name ]);
      };
      throw new Error("Failed pattern match at Lynx.Page.Form (line 181, column 8 - line 218, column 42): " + [ v.constructor.name ]);
  };
      ...
      var renderInput = function (v) {
          ...
          if (v.input instanceof Lynx_Data_Form.Dropdown) {
              return Halogen_HTML["slot'"](Halogen_Component_ChildPath.cp1)(v.key)(Ocelot_Component_Dropdown.component(dictMonadAff))({
                  ...
                  render: Ocelot_Component_Dropdown_Render.render(dictMonadAff)(Ocelot_Component_Dropdown_Render.defDropdown(Lynx_Data_ExprType.eqExprType)(Ocelot_Block_Button.button)([  ])(function ($91) {
                      return Data_Foldable.foldMap(Data_Foldable.foldableMaybe)(Data_Monoid.monoidString)(function ($92) {
                          return Lynx_Data_ExprType.print((function (v1) {
                              return v1.name;
                          })($92));
                      })(Lynx_Data_ExprType.toPair($91));
          ...
          if (v.input instanceof Lynx_Data_Form.Toggle) {
              return Ocelot_Block_Toggle.toggle([ Halogen_HTML_Properties.checked(Data_Maybe.fromMaybe(false)(Control_Bind.bindFlipped(Data_Maybe.bindMaybe)(Lynx_Data_ExprType.toBoolean)(Lynx_Data_Form.getValue(v.input.value0)))), Halogen_HTML_Properties.id_(v.key), Halogen_HTML_Events.onChecked(Halogen_HTML_Events.input(function ($93) {
                  return UpdateKey.create(v.key)(Lynx_Data_ExprType.boolean_($93));
              })) ]);
          };
          throw new Error("Failed pattern match at Lynx.Page.Form (line 141, column 25 - line 178, column 10): " + [ v.input.constructor.name ]);
      };
      ...
      var render = function (v) {
          return Ocelot_Block_Layout.section_((function () {
              ...
              if (v.form instanceof Network_RemoteData.Failure) {
                  return [ Ocelot_Block_Card.card_([ Ocelot_Block_Format.p([ Ocelot_HTML_Properties.css("text-red") ])([ Halogen_HTML_Core.text(Lynx_Data_Expr.renderEvalError(v.form.value0)) ]) ]) ];
              };
              ...
              throw new Error("Failed pattern match at Lynx.Page.Form (line 107, column 7 - line 121, column 51): " + [ v.form.constructor.name ]);
          })());
      };
