  ...
  var component = (function () {
      var renderInput = function (v) {
          if (v.input instanceof Lynx_Data_Form.Text) {
              return Ocelot_Block_Input.input([ Halogen_HTML_Properties.placeholder(Control_Comonad.extract(Data_Identity.comonadIdentity)(v.input.value0.placeholder)), Halogen_HTML_Properties.id_(v.key) ]);
          };
          ...
          throw new Error("Failed pattern match at Lynx.Page.Form line 99, column 25 - line 109, column 9: " + [ v.input.constructor.name ]);
      };
      var renderField = function (v) {
          return Ocelot_Block_FormField.field_({
              label: Halogen_HTML_Core.text(Control_Comonad.extract(Data_Identity.comonadIdentity)(v.name)),
              helpText: Data_Maybe.Just.create(Control_Comonad.extract(Data_Identity.comonadIdentity)(v.description)),
      ...
      var render = function (v) {
          return Ocelot_Block_Layout.section_((function () {
              ...
              if (v.form instanceof Data_Either.Right) {
                  return Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Ocelot_Block_Format.heading_([ Halogen_HTML_Core.text(v.form.value0.cur.name) ]) ])(Data_Functor.map(Data_Functor.functorArray)(renderSection)(v.form.value0.cur.contents));
              };
              throw new Error("Failed pattern match at Lynx.Page.Form line 71, column 7 - line 79, column 44: " + [ v.form.constructor.name ]);
          })());
      };
      var initialState = {
      ...
      var $$eval = function (v) {
          ...
          if (v instanceof EvalForm) {
              return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value1)(Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit));
          };
