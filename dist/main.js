...
(function(exports) {
  ...
  var string_ = function ($292) {
      return Val.create($$String.create($292));
  };
  var reflectType = function (v) {
      ...
      throw new Error("Failed pattern match at Lynx.Data.Expr (line 70, column 1 - line 70, column 34): " + [ v.constructor.name ]);
  };                        
  var print = function (v) {
      ...
      throw new Error("Failed pattern match at Lynx.Data.Expr (line 78, column 9 - line 83, column 16): " + [ v.constructor.name ]);
  };
  ...
  var evalExpr = function (get) {
      return function (v) {
          ...
          if (v instanceof Print) {
              return Data_Functor.map(Data_Either.functorEither)(function ($294) {
                  return $$String.create(print($294));
          ...
          throw new Error("Failed pattern match at Lynx.Data.Expr (line 230, column 16 - line 247, column 60): " + [ v.constructor.name ]);
      };
  };                        
  ...
  var boolean_ = function ($296) {
      return Val.create($$Boolean.create($296));
  };
  exports["Array"] = $$Array;
...
(function(exports) {
  ...
  var singletonError = function (dictOrd) {
      return function ($266) {
          return Errors(Data_Set.singleton($266));
      };
  };
          ...
          return function (page) {
              var setField = function (field) {
                  if (key === field.key) {
                      ...
                      throw new Error("Failed pattern match at Lynx.Data.Form (line 338, column 26 - line 344, column 71): " + [ field.input.constructor.name ]);
                  };
                  if (Data_Boolean.otherwise) {
                      return field;
                  };
                  throw new Error("Failed pattern match at Lynx.Data.Form (line 336, column 3 - line 336, column 39): " + [ field.constructor.name ]);
              };
  ...
  var isEmpty = function (v) {
      ...
      if (v instanceof Data_Maybe.Just) {
          ...
          throw new Error("Failed pattern match at Lynx.Data.Form (line 315, column 20 - line 322, column 21): " + [ v.value0.constructor.name ]);
      };
      throw new Error("Failed pattern match at Lynx.Data.Form (line 313, column 1 - line 313, column 37): " + [ v.constructor.name ]);
  };
  ...
  var keys = function (page) {
      var keysField = function (field) {
          var value = (function () {
              ...
              throw new Error("Failed pattern match at Lynx.Data.Form (line 302, column 13 - line 305, column 39): " + [ field.input.constructor.name ]);
          })();
          if (value instanceof Data_Maybe.Just) {
              ...
              throw new Error("Failed pattern match at Lynx.Data.Form (line 297, column 18 - line 299, column 48): " + [ v.constructor.name ]);
          };
          if (value instanceof Data_Maybe.Nothing) {
              return Data_Monoid.mempty(Data_Map_Internal.monoidMap(Data_Ord.ordString));
          };
          throw new Error("Failed pattern match at Lynx.Data.Form (line 296, column 21 - line 300, column 22): " + [ value.constructor.name ]);
      };
  ...
  var functorInputSource = new Data_Functor.Functor(function (f) {
      return function (m) {
          ...
          throw new Error("Failed pattern match at Lynx.Data.Form (line 103, column 8 - line 103, column 58): " + [ m.constructor.name ]);
      };
  });
  var foldableInputSource = new Data_Foldable.Foldable(function (dictMonoid) {
      return function (f) {
          return function (v) {
              ...
              throw new Error("Failed pattern match at Lynx.Data.Form (line 108, column 15 - line 111, column 21): " + [ v.constructor.name ]);
          };
      };
  }, function (f) {
  ...
  var traversableInputSource = new Data_Traversable.Traversable(function () {
      ...
      return function (f) {
          return function (v) {
              ...
              throw new Error("Failed pattern match at Lynx.Data.Form (line 117, column 16 - line 120, column 26): " + [ v.constructor.name ]);
          };
      };
  });
  ...
  var ordValidationError = new Data_Ord.Ord(function () {
      ...
      return function (y) {
          ...
          throw new Error("Failed pattern match at Lynx.Data.Form (line 188, column 8 - line 188, column 58): " + [ x.constructor.name, y.constructor.name ]);
      };
  });
  var firstName = {
  ...
  var $$eval = function (get) {
      return function (page) {
          var validateRequired = function (input) {
              var $230 = Data_Eq.eq(Lynx_Data_Expr.eqExprType)(input.required)(new Lynx_Data_Expr["Boolean"](true)) && isEmpty(getValue(input));
              if ($230) {
          ...
          var validate = function (v) {
              ...
              throw new Error("Failed pattern match at Lynx.Data.Form (line 269, column 14 - line 278, column 33): " + [ v.constructor.name ]);
          };
          var evalInput = function (v) {
              ...
              throw new Error("Failed pattern match at Lynx.Data.Form (line 232, column 15 - line 266, column 66): " + [ v.constructor.name ]);
          };
  ...
  var testSection = {
      name: "Name",
      contents: [ firstName, lastName, active, food ]
  };
  var testPage = {
      name: "Profile",
  ...
  var $$eval = function (v) {
      if (v instanceof Initialize) {
          return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value0)(Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
              ...
              $19.values = Lynx_Data_Form.keys(Lynx_Data_Form.testPage);
              return $19;
          }))(function () {
              return Data_Functor["void"](Halogen_Query_HalogenM.functorHalogenM)(Data_Bifoldable.bitraverse_(Data_Either.bifoldableEither)(Halogen_Query_HalogenM.applicativeHalogenM)(function (e) {
                  return Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                      ...
                      $22.form = new Network_RemoteData.Failure(e);
                      return $22;
                  });
              })(function (f) {
              ...
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Data_Traversable["for"](Halogen_Query_HalogenM.applicativeHalogenM)(Data_Either.traversableEither)(evaled$prime)(function (page) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Data_Foldable.for_(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Foldable.foldableArray)(page.contents)(function (section) {
                      return Data_Foldable.for_(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Foldable.foldableArray)(section.contents)(function (field) {
                          ...
                          throw new Error("Failed pattern match at Lynx.Page.Form (line 188, column 11 - line 193, column 34): " + [ field.input.constructor.name ]);
                      });
                  }))(function () {
                  ...
                  return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                      ...
                      $32.form = Data_Functor.map(Network_RemoteData.functorRemoteData)(function (v4) {
                          return {
                              expr: v.value0,
                              evaled: v4
                          };
      ...
      if (v instanceof UpdateKey) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
              ...
              $38.values = Data_Map_Internal.insert(Data_Ord.ordString)(v.value0)(v.value1)(state.values);
              return $38;
          }))(function () {
      ...
      if (v instanceof DropdownQuery) {
          ...
          throw new Error("Failed pattern match at Lynx.Page.Form (line 205, column 34 - line 208, column 42): " + [ v.value1.constructor.name ]);
      };
      throw new Error("Failed pattern match at Lynx.Page.Form (line 174, column 8 - line 208, column 42): " + [ v.constructor.name ]);
  };
  var component = function (dictMonadAff) {
      var renderValidation = (function () {
          var renderValidationError = function (v) {
              ...
              throw new Error("Failed pattern match at Lynx.Page.Form (line 168, column 29 - line 173, column 1): " + [ v.constructor.name ]);
          };
          var renderValidation$prime = function ($78) {
              return Data_Functor.map(Data_Maybe.functorMaybe)(renderValidationError)(Data_Array.head(Lynx_Data_Form.errorsToArray(Lynx_Data_Form.ordValidationError)($78)));
          };
          return function (v) {
              ...
              throw new Error("Failed pattern match at Lynx.Page.Form (line 160, column 22 - line 163, column 53): " + [ v.constructor.name ]);
          };
      })();
      var renderInput = function (v) {
          if (v.input instanceof Lynx_Data_Form.Dropdown) {
              return Halogen_HTML["slot'"](Halogen_Component_ChildPath.cp1)(v.key)(Ocelot_Component_Dropdown.component(dictMonadAff))({
                  ...
                  render: Ocelot_Component_Dropdown_Render.render(dictMonadAff)(Ocelot_Component_Dropdown_Render.defDropdown(Lynx_Data_Expr.eqExprType)(Ocelot_Block_Button.button)([  ])(function ($79) {
                      return Data_Foldable.foldMap(Data_Foldable.foldableMaybe)(Data_Monoid.monoidString)(function ($80) {
                          return Lynx_Data_Expr.print((function (v1) {
                              return v1.name;
                          })($80));
                      })(Lynx_Data_Expr.toPair($79));
          ...
          if (v.input instanceof Lynx_Data_Form.Text) {
              return Ocelot_Block_Input.input([ Halogen_HTML_Properties.value(Data_Maybe.fromMaybe("")(Control_Bind.bindFlipped(Data_Maybe.bindMaybe)(Lynx_Data_Expr.toString)(Lynx_Data_Form.getValue(v.input.value0)))), Halogen_HTML_Properties.placeholder(Lynx_Data_Expr.print(v.input.value0.placeholder)), Halogen_HTML_Properties.id_(v.key), Halogen_HTML_Events.onValueInput(Halogen_HTML_Events.input(function ($81) {
                  return UpdateKey.create(v.key)(Lynx_Data_Expr["String"].create($81));
              })) ]);
          };
          if (v.input instanceof Lynx_Data_Form.Toggle) {
              return Ocelot_Block_Toggle.toggle([ Halogen_HTML_Properties.checked(Data_Maybe.fromMaybe(false)(Control_Bind.bindFlipped(Data_Maybe.bindMaybe)(Lynx_Data_Expr.toBoolean)(Lynx_Data_Form.getValue(v.input.value0)))), Halogen_HTML_Properties.id_(v.key), Halogen_HTML_Events.onChecked(Halogen_HTML_Events.input(function ($82) {
                  return UpdateKey.create(v.key)(Lynx_Data_Expr["Boolean"].create($82));
              })) ]);
          };
          throw new Error("Failed pattern match at Lynx.Page.Form (line 128, column 25 - line 157, column 10): " + [ v.input.constructor.name ]);
      };
