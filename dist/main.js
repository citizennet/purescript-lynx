...
(function(exports) {
  ...
  var Lookup = (function () {
      function Lookup(value0, value1, value2, value3) {
          this.value0 = value0;
          this.value1 = value1;
          this.value2 = value2;
          this.value3 = value3;
      ...
      Lookup.create = function (value0) {
          return function (value1) {
              return function (value2) {
                  return function (value3) {
                      return new Lookup(value0, value1, value2, value3);
                  };
              };
          };
      };
  ...
  var val_ = function (dictExpressible) {
      return function (x) {
          return mkExpr(exprVoid)(dictExpressible)(new Val(Control_Category.identity(Data_Leibniz.categoryLeibniz), x));
      };
  };
  ...
  var lookup_ = function (dictExpressible) {
      return function (x) {
          return function (y) {
              return function (z) {
                  return mkExpr(exprString)(dictExpressible)(new Lookup(Control_Category.identity(Data_Leibniz.categoryLeibniz), x, y, z));
              };
          };
      };
  };
  ...
  var evalExpr$prime = function (dictExpressible) {
      var $$eval = function (dictExpressible1) {
          return function (v) {
              if (v instanceof Val) {
                  return v.value1;
              };
              if (v instanceof If) {
                  var $113 = evalExpr$prime(exprBoolean)(v.value1);
                  if ($113) {
                      return evalExpr$prime(dictExpressible)(v.value2);
                  };
                  return evalExpr$prime(dictExpressible)(v.value3);
              };
              if (v instanceof Equal) {
                  return Data_Leibniz.coerceSymm(v.value0)(Data_Eq.eq(dictExpressible1.Eq1())(evalExpr$prime(dictExpressible1)(v.value1))(evalExpr$prime(dictExpressible1)(v.value2)));
              };
              if (v instanceof Print) {
                  return Data_Leibniz.coerceSymm(v.value0)(print(dictExpressible1)(evalExpr$prime(dictExpressible1)(v.value1)));
              };
              if (v instanceof Lookup) {
                  var v1 = v.value3(v.value1);
                  if (v1 instanceof Data_Maybe.Nothing) {
                      return evalExpr$prime(dictExpressible)(v.value2);
                  };
                  if (v1 instanceof Data_Maybe.Just) {
                  ...
                  throw new Error("Failed pattern match at Lynx.Data.Expr line 127, column 27 - line 129, column 16: " + [ v1.constructor.name ]);
              };
              throw new Error("Failed pattern match at Lynx.Data.Expr line 122, column 3 - line 122, column 47: " + [ v.constructor.name ]);
          };
      };
      return runExpr(function (dictExpressible1) {
          return $$eval(dictExpressible1);
      });
  };
  exports["print"] = print;
  ...
  exports["evalExpr'"] = evalExpr$prime;
...
(function(exports) {
  ...
  var lastName = {
      name: Lynx_Data_Expr.val_(Lynx_Data_Expr.exprString)("Last Name"),
      visibility: Lynx_Data_Expr.val_(Lynx_Data_Expr.exprBoolean)(true),
      description: Lynx_Data_Expr.val_(Lynx_Data_Expr.exprString)("Enter your last name"),
      key: "lastName",
      input: new Text({
          "default": Data_Maybe.Nothing.value,
          maxLength: Data_Maybe.Nothing.value,
          minLength: Data_Maybe.Nothing.value,
          placeholder: Lynx_Data_Expr.val_(Lynx_Data_Expr.exprString)(""),
          required: Lynx_Data_Expr.val_(Lynx_Data_Expr.exprBoolean)(true),
          value: {
  ...
  var firstName = {
      name: Lynx_Data_Expr.val_(Lynx_Data_Expr.exprString)("First Name"),
      visibility: Lynx_Data_Expr.val_(Lynx_Data_Expr.exprBoolean)(true),
      description: Lynx_Data_Expr.val_(Lynx_Data_Expr.exprString)("Enter your first name"),
      key: "firstName",
      input: new Text({
          "default": Data_Maybe.Nothing.value,
          maxLength: Data_Maybe.Nothing.value,
  ...
  var active = function (f) {
      var go = function ($36) {
          return Control_Applicative.pure(Data_Maybe.applicativeMaybe)((function (v) {
              if (v instanceof Data_Maybe.Nothing) {
                  return "Is user's account active?";
              };
              if (v instanceof Data_Maybe.Just && !v.value0) {
                  return "User's account is not active.";
              };
              if (v instanceof Data_Maybe.Just && v.value0) {
                  return "User's account is active.";
              };
              throw new Error("Failed pattern match at Lynx.Data.Form line 260, column 17 - line 263, column 18: " + [ v.constructor.name ]);
          })($36));
      };
      return {
          name: Lynx_Data_Expr.val_(Lynx_Data_Expr.exprString)("Active"),
          visibility: Lynx_Data_Expr.val_(Lynx_Data_Expr.exprBoolean)(true),
          description: Lynx_Data_Expr.lookup_(Lynx_Data_Expr.exprString)("active")(Lynx_Data_Expr.val_(Lynx_Data_Expr.exprString)("Is user's account active"))(function ($37) {
              return go(f($37));
          }),
          key: "active",
          input: new Toggle({
              "default": new Data_Maybe.Just(Lynx_Data_Expr.val_(Lynx_Data_Expr.exprBoolean)(false)),
              value: {
                  source: Data_Maybe.Nothing.value,
                  value: Data_Maybe.Nothing.value
              }
  ...
  var testSection = function (f) {
      return {
          name: "Name",
          contents: [ firstName, lastName, active(f) ]
      };
  };
  var testPage = function (f) {
      return {
          name: "Profile",
          contents: [ testSection(f) ]
      };
  };
  exports["Text"] = Text;
  ...
  var component = (function () {
      var renderInput = function (v) {
          if (v.input instanceof Lynx_Data_Form.Text) {
              return Ocelot_Block_Input.input([ Halogen_HTML_Properties.placeholder(Data_Show.show(Data_Identity.showIdentity(Data_Show.showString))(v.input.value0.placeholder)), Halogen_HTML_Properties.id_(v.key) ]);
          };
          ...
          throw new Error("Failed pattern match at Lynx.Page.Form line 137, column 25 - line 147, column 9: " + [ v.input.constructor.name ]);
      };
      var renderField = function (v) {
          return Ocelot_Block_FormField.field_({
              label: Halogen_HTML_Core.text(Data_Show.show(Data_Identity.showIdentity(Data_Show.showString))(v.name)),
              helpText: Data_Maybe.Just.create(Data_Show.show(Data_Identity.showIdentity(Data_Show.showString))(v.description)),
      ...
      var render = function (v) {
          return Ocelot_Block_Layout.section_((function () {
              ...
              throw new Error("Failed pattern match at Lynx.Page.Form line 109, column 7 - line 117, column 51: " + [ v.form.constructor.name ]);
          })());
      };
      var initialState = {
      ...
      var evalInput = function (v) {
          if (v instanceof Lynx_Data_Form.Text) {
              return new Lynx_Data_Form.Text({
                  "default": Data_Functor.map(Data_Maybe.functorMaybe)(function ($41) {
                      return Control_Applicative.pure(Data_Identity.applicativeIdentity)(Lynx_Data_Expr["evalExpr'"](Lynx_Data_Expr.exprString)($41));
                  })(v["value0"]["default"]),
                  maxLength: Data_Functor.map(Data_Maybe.functorMaybe)(function ($42) {
                      return Control_Applicative.pure(Data_Identity.applicativeIdentity)(Lynx_Data_Expr["evalExpr'"](Lynx_Data_Expr.exprInt)($42));
                  })(v.value0.maxLength),
                  minLength: Data_Functor.map(Data_Maybe.functorMaybe)(function ($43) {
                      return Control_Applicative.pure(Data_Identity.applicativeIdentity)(Lynx_Data_Expr["evalExpr'"](Lynx_Data_Expr.exprInt)($43));
                  })(v.value0.minLength),
                  placeholder: Control_Applicative.pure(Data_Identity.applicativeIdentity)(Lynx_Data_Expr["evalExpr'"](Lynx_Data_Expr.exprString)(v.value0.placeholder)),
                  required: Control_Applicative.pure(Data_Identity.applicativeIdentity)(Lynx_Data_Expr["evalExpr'"](Lynx_Data_Expr.exprBoolean)(v.value0.required)),
                  value: v.value0.value
              });
          };
          if (v instanceof Lynx_Data_Form.Toggle) {
              return new Lynx_Data_Form.Toggle({
                  "default": Data_Functor.map(Data_Maybe.functorMaybe)(function ($44) {
                      return Control_Applicative.pure(Data_Identity.applicativeIdentity)(Lynx_Data_Expr["evalExpr'"](Lynx_Data_Expr.exprBoolean)($44));
                  })(v["value0"]["default"]),
                  value: v.value0.value
              });
          };
          throw new Error("Failed pattern match at Lynx.Page.Form line 92, column 15 - line 104, column 8: " + [ v.constructor.name ]);
      };
      var evalField = function (field) {
          return {
              name: Control_Applicative.pure(Data_Identity.applicativeIdentity)(Lynx_Data_Expr["evalExpr'"](Lynx_Data_Expr.exprString)(field.name)),
              visibility: Control_Applicative.pure(Data_Identity.applicativeIdentity)(Lynx_Data_Expr["evalExpr'"](Lynx_Data_Expr.exprBoolean)(field.visibility)),
              description: Control_Applicative.pure(Data_Identity.applicativeIdentity)(Lynx_Data_Expr["evalExpr'"](Lynx_Data_Expr.exprString)(field.description)),
              key: field.key,
      ...
      var evalSection = function (section) {
          return {
              name: section.name,
              contents: Data_Functor.map(Data_Functor.functorArray)(evalField)(section.contents)
          };
      };
      var evalPage = function (page) {
          return {
              name: page.name,
              contents: Data_Functor.map(Data_Functor.functorArray)(evalSection)(page.contents)
          };
      };
      var $$eval = function (v) {
          if (v instanceof Initialize) {
              return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value0)(Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  ...
                  var get = function (key) {
                      return Data_Map_Internal.lookup(Data_Ord.ordString)(key)(v1);
                  };
                  return Data_Functor["void"](Halogen_Query_HalogenM.functorHalogenM)(Data_Bifoldable.bitraverse_(Data_Either.bifoldableEither)(Halogen_Query_HalogenM.applicativeHalogenM)(function (e) {
                      return Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                          ...
                          $31.form = new Data_Either.Left(e);
                          return $31;
                      });
                  })(function (f) {
                      return $$eval(new EvalForm(f, v.value0));
                  })(Data_Either.Right.create(Lynx_Data_Form.testPage(get))));
              }));
          };
          if (v instanceof EvalForm) {
              return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value1)(Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  ...
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                      ...
                      $36.form = Control_Applicative.pure(Data_Either.applicativeEither)({
                          expr: v.value0,
                          evaled: evaled
                      });
                      return $36;
          ...
          throw new Error("Failed pattern match at Lynx.Page.Form line 57, column 3 - line 57, column 56: " + [ v.constructor.name ]);
      };
