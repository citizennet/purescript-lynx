...
(function(exports) {
  ...
  var string_ = function ($235) {
      return Val.create($$String.create($235));
  };
  var reflectType = function (v) {
      ...
      throw new Error("Failed pattern match at Lynx.Data.Expr (line 46, column 1 - line 46, column 34): " + [ v.constructor.name ]);
  };                        
  var print = function (v) {
      ...
      throw new Error("Failed pattern match at Lynx.Data.Expr (line 52, column 9 - line 55, column 16): " + [ v.constructor.name ]);
  };
  ...
  var genericExprType = new Data_Generic_Rep.Generic(function (x) {
      ...
      throw new Error("Failed pattern match at Lynx.Data.Expr (line 25, column 8 - line 25, column 54): " + [ x.constructor.name ]);
  }, function (x) {
      if (x instanceof Data_Generic_Rep.Inl) {
          return new $$Boolean(x.value0);
      };
      if (x instanceof Data_Generic_Rep.Inr && x.value0 instanceof Data_Generic_Rep.Inl) {
          return new Int(x.value0.value0);
      };
      if (x instanceof Data_Generic_Rep.Inr && x.value0 instanceof Data_Generic_Rep.Inr) {
          return new $$String(x.value0.value0);
      };
      throw new Error("Failed pattern match at Lynx.Data.Expr (line 25, column 8 - line 25, column 54): " + [ x.constructor.name ]);
  });
  var showExprType = new Data_Show.Show(Data_Generic_Rep_Show.genericShow(genericExprType)(Data_Generic_Rep_Show.genericShowSum(Data_Generic_Rep_Show.genericShowConstructor(Data_Generic_Rep_Show.genericShowArgsArgument(Data_Show.showBoolean))(new Data_Symbol.IsSymbol(function () {
      return "Boolean";
  ...
  var evalExpr = function (get) {
      return function (v) {
          ...
          if (v instanceof Print) {
              return Data_Functor.map(Data_Either.functorEither)(function ($237) {
                  return $$String.create(print($237));
          ...
          throw new Error("Failed pattern match at Lynx.Data.Expr (line 171, column 16 - line 188, column 60): " + [ v.constructor.name ]);
      };
  }; 
  var boolean_ = function ($239) {
      return Val.create($$Boolean.create($239));
  };
...
(function(exports) {
  ...
  var functorInputSource = new Data_Functor.Functor(function (f) {
      return function (m) {
          ...
          throw new Error("Failed pattern match at Lynx.Data.Form (line 90, column 8 - line 90, column 58): " + [ m.constructor.name ]);
      };
  });
  var foldableInputSource = new Data_Foldable.Foldable(function (dictMonoid) {
      return function (f) {
          return function (v) {
              ...
              throw new Error("Failed pattern match at Lynx.Data.Form (line 95, column 15 - line 98, column 21): " + [ v.constructor.name ]);
          };
      };
  }, function (f) {
  ...
  var traversableInputSource = new Data_Traversable.Traversable(function () {
      ...
      return function (f) {
          return function (v) {
              ...
              throw new Error("Failed pattern match at Lynx.Data.Form (line 104, column 16 - line 107, column 26): " + [ v.constructor.name ]);
          };
      };
  });
  var firstName = {
  ...
  var testSection = {
      name: "Name",
      contents: [ firstName, lastName, active ]
  };
  var testPage = {
      name: "Profile",
  ...
  var component = (function () {
                  ...
                  if (key === field.key) {
                      if (field.input instanceof Lynx_Data_Form.Text) {
                          return {
                              ...
                              key: field.key,
                              input: new Lynx_Data_Form.Text({
                                  "default": field["input"]["value0"]["default"],
                                  value: new Lynx_Data_Form.UserInput(new Lynx_Data_Expr.Val(val)),
                      ...
                      if (field.input instanceof Lynx_Data_Form.Toggle) {
                          return {
                              ...
                              description: field.description,
                              key: field.key,
                              input: new Lynx_Data_Form.Toggle({
                                  "default": field["input"]["value0"]["default"],
                                  value: new Lynx_Data_Form.UserInput(new Lynx_Data_Expr.Val(val))
                              })
                          };
                      };
                      throw new Error("Failed pattern match at Lynx.Page.Form (line 218, column 26 - line 222, column 71): " + [ field.input.constructor.name ]);
                  };
                  if (Data_Boolean.otherwise) {
                      return field;
                  };
                  throw new Error("Failed pattern match at Lynx.Page.Form (line 216, column 3 - line 216, column 58): " + [ key.constructor.name, val.constructor.name, field.constructor.name ]);
              };
          };
      };
      var setSection = function (key) {
          return function (val) {
              return function (section) {
                  return {
                      name: section.name,
                      contents: Data_Functor.map(Data_Functor.functorArray)(setField(key)(val))(section.contents)
                  };
              };
          };
      };
      var setPage = function (key) {
          return function (val) {
              return function (page) {
                  return {
                      name: page.name,
                      contents: Data_Functor.map(Data_Functor.functorArray)(setSection(key)(val))(page.contents)
                  };
              };
          };
      };
      var renderInput = function (v) {
          if (v.input instanceof Lynx_Data_Form.Text) {
              return Ocelot_Block_Input.input([ Halogen_HTML_Properties.placeholder(Data_Show.show(Lynx_Data_Expr.showExprType)(v.input.value0.placeholder)), Halogen_HTML_Properties.id_(v.key) ]);
          };
          if (v.input instanceof Lynx_Data_Form.Toggle) {
              return Ocelot_Block_Toggle.toggle([ Halogen_HTML_Properties.checked(true), Halogen_HTML_Properties.id_(v.key), Halogen_HTML_Events.onChecked(Halogen_HTML_Events.input(function ($131) {
                  return UpdateKey.create(v.key)(Lynx_Data_Expr["Boolean"].create($131));
              })) ]);
          };
          throw new Error("Failed pattern match at Lynx.Page.Form (line 195, column 25 - line 206, column 10): " + [ v.input.constructor.name ]);
      };
      var renderField = function (v) {
          return Ocelot_Block_FormField.field_({
              label: Halogen_HTML_Core.text(Data_Show.show(Lynx_Data_Expr.showExprType)(v.name)),
              helpText: Data_Maybe.Just.create(Data_Show.show(Lynx_Data_Expr.showExprType)(v.description)),
      ...
      var renderEvalError = function (v) {
          ...
          throw new Error("Failed pattern match at Lynx.Page.Form (line 163, column 21 - line 175, column 33): " + [ v.constructor.name ]);
      };
      var render = function (v) {
          return Ocelot_Block_Layout.section_((function () {
              ...
              throw new Error("Failed pattern match at Lynx.Page.Form (line 148, column 7 - line 160, column 51): " + [ v.form.constructor.name ]);
          })());
      };
          ...
          var v = function (v1) {
              var v2 = function (v3) {
                  var v4 = function (v5) {
                      ...
                      if (field.input instanceof Lynx_Data_Form.Toggle && field["input"]["value0"]["default"] instanceof Data_Maybe.Just) {
                          var $65 = Lynx_Data_Expr.evalExpr(Data_Function["const"](Data_Maybe.Nothing.value))(field["input"]["value0"]["default"].value0);
                          if ($65 instanceof Data_Either.Right) {
                              return Data_Map_Internal.singleton(field.key)($65.value0);
                          };
                          return v6(true);
                      };
                      return v6(true);
                  };
                  if (field.input instanceof Lynx_Data_Form.Toggle && field.input.value0.value instanceof Lynx_Data_Form.UserInput) {
                      var $71 = Lynx_Data_Expr.evalExpr(Data_Function["const"](Data_Maybe.Nothing.value))(field.input.value0.value.value0);
                      if ($71 instanceof Data_Either.Right) {
                          return Data_Map_Internal.singleton(field.key)($71.value0);
                      };
                      return v4(true);
                  };
                  return v4(true);
              };
              if (field.input instanceof Lynx_Data_Form.Text && field["input"]["value0"]["default"] instanceof Data_Maybe.Just) {
                  var $77 = Lynx_Data_Expr.evalExpr(Data_Function["const"](Data_Maybe.Nothing.value))(field["input"]["value0"]["default"].value0);
                  if ($77 instanceof Data_Either.Right) {
                      return Data_Map_Internal.singleton(field.key)($77.value0);
                  };
                  return v2(true);
              };
              return v2(true);
          };
          if (field.input instanceof Lynx_Data_Form.Text && field.input.value0.value instanceof Lynx_Data_Form.UserInput) {
              var $83 = Lynx_Data_Expr.evalExpr(Data_Function["const"](Data_Maybe.Nothing.value))(field.input.value0.value.value0);
              if ($83 instanceof Data_Either.Right) {
                  return Data_Map_Internal.singleton(field.key)($83.value0);
              };
              return v(true);
          };
          return v(true);
      ...
      var evalInput = function (get) {
          return function (v) {
                          ...
                          return Control_Bind.bind(Data_Either.bindEither)(Data_Traversable.traverse(Data_Traversable.traversableMaybe)(Data_Either.applicativeEither)(Lynx_Data_Expr.evalExpr(get))(v.value0.minLength))(function (v3) {
                              return Control_Bind.bind(Data_Either.bindEither)(Lynx_Data_Expr.evalExpr(get)(v.value0.placeholder))(function (v4) {
                                  return Control_Bind.bind(Data_Either.bindEither)(Lynx_Data_Expr.evalExpr(get)(v.value0.required))(function (v5) {
                                      return Control_Bind.bind(Data_Either.bindEither)(Data_Traversable.traverse(Lynx_Data_Form.traversableInputSource)(Data_Either.applicativeEither)(Lynx_Data_Expr.evalExpr(get))(v.value0.value))(function (v6) {
                                          return Control_Applicative.pure(Data_Either.applicativeEither)(new Lynx_Data_Form.Text({
                                              "default": v1,
                                              maxLength: v2,
                                              minLength: v3,
                                              placeholder: v4,
              ...
              if (v instanceof Lynx_Data_Form.Toggle) {
                  return Control_Bind.bind(Data_Either.bindEither)(Data_Traversable.traverse(Data_Traversable.traversableMaybe)(Data_Either.applicativeEither)(Lynx_Data_Expr.evalExpr(get))(v["value0"]["default"]))(function (v1) {
                      return Control_Bind.bind(Data_Either.bindEither)(Data_Traversable.traverse(Lynx_Data_Form.traversableInputSource)(Data_Either.applicativeEither)(Lynx_Data_Expr.evalExpr(get))(v.value0.value))(function (v2) {
                          return Control_Applicative.pure(Data_Either.applicativeEither)(new Lynx_Data_Form.Toggle({
                              "default": v1,
                              value: v2
                          }));
                      });
              ...
              throw new Error("Failed pattern match at Lynx.Page.Form (line 100, column 19 - line 121, column 39): " + [ v.constructor.name ]);
          };
      };
      var evalField = function (get) {
          return function (field) {
              return Control_Bind.bind(Data_Either.bindEither)(Lynx_Data_Expr.evalExpr(get)(field.description))(function (v) {
                  return Control_Bind.bind(Data_Either.bindEither)(evalInput(get)(field.input))(function (v1) {
      ...
      var evalSection = function (get) {
          return function (section) {
              return Control_Bind.bind(Data_Either.bindEither)(Data_Traversable.traverse(Data_Traversable.traversableArray)(Data_Either.applicativeEither)(evalField(get))(section.contents))(function (v) {
                  return Control_Applicative.pure(Data_Either.applicativeEither)({
                      contents: v,
                      name: section.name
                  });
      ...
      var evalPage = function (get) {
          return function (page) {
              return Control_Bind.bind(Data_Either.bindEither)(Data_Traversable.traverse(Data_Traversable.traversableArray)(Data_Either.applicativeEither)(evalSection(get))(page.contents))(function (v) {
                  return Control_Applicative.pure(Data_Either.applicativeEither)({
                      contents: v,
                      name: page.name
                  });
      ...
      var $$eval = function (v) {
          if (v instanceof Initialize) {
              return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value0)(Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  ...
                  $106.values = keysPage(Lynx_Data_Form.testPage);
                  return $106;
              }))(function () {
                  return Data_Functor["void"](Halogen_Query_HalogenM.functorHalogenM)(Data_Bifoldable.bitraverse_(Data_Either.bifoldableEither)(Halogen_Query_HalogenM.applicativeHalogenM)(function (e) {
                      return Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                          ...
                          $109.form = new Network_RemoteData.Failure(e);
                          return $109;
                      });
                  })(function (f) {
          ...
          if (v instanceof EvalForm) {
              return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value1)(Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  var evaled = evalPage(function (key) {
                  ...
                  return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                      ...
                      $114.form = Data_Functor.map(Network_RemoteData.functorRemoteData)(function (v3) {
                          return {
                              expr: v.value0,
                              evaled: v3
                          };
          ...
          if (v instanceof UpdateKey) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                  ...
                  $120.values = Data_Map_Internal.insert(Data_Ord.ordString)(v.value0)(v.value1)(state.values);
                  return $120;
              }))(function () {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                      if (v1.form instanceof Network_RemoteData.Success) {
                          return $$eval(new EvalForm(setPage(v.value0)(v.value1)(v1.form.value0.expr), v.value2));
                      };
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value2);
                  });
              });
          };
          throw new Error("Failed pattern match at Lynx.Page.Form (line 61, column 3 - line 61, column 56): " + [ v.constructor.name ]);
      };
