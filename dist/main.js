      ...
      return new Data_Show.Show((function () {
          var go = function (dictExpressible1) {
              return function (v) {
                  ...
                  throw new Error("Failed pattern match at Lynx.Data.Expr line 102, column 7 - line 102, column 54: " + [ v.constructor.name ]);
              };
          };
...
(function(exports) {
  ...
  var toggleInput = "\x0a  { \"type\": \"Toggle\"\x0a  , \"value\": { \"value\": null, \"source\": null }\x0a  , \"default\": " + (val(Data_Show.showBoolean)(false)("Boolean") + "\x0a  }\x0a");
  var textInput = "\x0a  { \"type\": \"Text\"\x0a  , \"required\": " + (val(Data_Show.showBoolean)(true)("Boolean") + ("\x0a  , \"placeholder\": " + (val(Data_Show.showString)("")("String") + "\x0a  , \"value\": { \"value\": null, \"source\": null }\x0a  , \"default\": null\x0a  , \"maxLength\": null\x0a  , \"minLength\": null\x0a  }\x0a")));
  var testField = function (n) {
      return function (d) {
          return function (i) {
  ...
  var lastName = testField("Last Name")("Enter your last name")(textInput);
  var firstName = testField("First Name")("Enter your first name")(textInput);
  var decodeInputSource = new Data_Argonaut_Decode_Class.DecodeJson(Control_Bind.composeKleisli(Data_Either.bindEither)(Data_Argonaut_Decode_Class.decodeJson(Data_Argonaut_Decode_Class.decodeJsonString))(function (v) {
      if (v === "UserInput") {
          return Control_Applicative.pure(Data_Either.applicativeEither)(UserInput.value);
      };
      if (v === "DefaultValue") {
          return Control_Applicative.pure(Data_Either.applicativeEither)(DefaultValue.value);
      };
      if (v === "Invalid") {
          return Control_Applicative.pure(Data_Either.applicativeEither)(Invalid.value);
      };
      return Data_Either.Left.create(v + " is not a valid InputSource");
  }));
  var decodeInput = new Data_Argonaut_Decode_Class.DecodeJson(function (json) {
      return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Class.decodeJson(Data_Argonaut_Decode_Class.decodeForeignObject(Data_Argonaut_Decode_Class.decodeJsonJson))(json))(function (v) {
          return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(Data_Argonaut_Decode_Class.decodeJsonString)(v)("type"))(function (v1) {
              if (v1 === "Text") {
                  return Control_Bind.composeKleisliFlipped(Data_Either.bindEither)(function ($31) {
                      return Control_Applicative.pure(Data_Either.applicativeEither)(Text.create($31));
                  })(Data_Argonaut_Decode_Class.decodeJson(Data_Argonaut_Decode_Class.decodeRecord(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeJsonMaybe(Lynx_Data_Expr.decodeExprString))(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeJsonMaybe(Lynx_Data_Expr.decodeExprInt))(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeJsonMaybe(Lynx_Data_Expr.decodeExprInt))(Data_Argonaut_Decode_Class.gDecodeJsonCons(Lynx_Data_Expr.decodeExprString)(Data_Argonaut_Decode_Class.gDecodeJsonCons(Lynx_Data_Expr.decodeExprBoolean)(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeRecord(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeJsonMaybe(decodeInputSource))(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeJsonMaybe(Data_Argonaut_Decode_Class.decodeJsonString))(Data_Argonaut_Decode_Class.gDecodeJsonNil)(new Data_Symbol.IsSymbol(function () {
                      return "value";
              ...
              if (v1 === "Toggle") {
                  return Control_Bind.composeKleisliFlipped(Data_Either.bindEither)(function ($32) {
                      return Control_Applicative.pure(Data_Either.applicativeEither)(Toggle.create($32));
                  })(Data_Argonaut_Decode_Class.decodeJson(Data_Argonaut_Decode_Class.decodeRecord(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeJsonMaybe(Lynx_Data_Expr.decodeExprBoolean))(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeRecord(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeJsonMaybe(decodeInputSource))(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeJsonMaybe(Data_Argonaut_Decode_Class.decodeJsonBoolean))(Data_Argonaut_Decode_Class.gDecodeJsonNil)(new Data_Symbol.IsSymbol(function () {
                      return "value";
                  }))()())(new Data_Symbol.IsSymbol(function () {
                      return "source";
                  }))()())())(Data_Argonaut_Decode_Class.gDecodeJsonNil)(new Data_Symbol.IsSymbol(function () {
  ...
  var active = testField("Active")("Is user's account active")(toggleInput);
  ...
  // Test
  var testPageEither = Control_Bind.bindFlipped(Data_Either.bindEither)(Data_Argonaut_Decode_Class.decodeJson(Data_Argonaut_Decode_Class.decodeRecord(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeArray(Data_Argonaut_Decode_Class.decodeRecord(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeArray(Data_Argonaut_Decode_Class.decodeRecord(Data_Argonaut_Decode_Class.gDecodeJsonCons(Lynx_Data_Expr.decodeExprString)(Data_Argonaut_Decode_Class.gDecodeJsonCons(decodeInput)(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeJsonString)(Data_Argonaut_Decode_Class.gDecodeJsonCons(Lynx_Data_Expr.decodeExprString)(Data_Argonaut_Decode_Class.gDecodeJsonCons(Lynx_Data_Expr.decodeExprBoolean)(Data_Argonaut_Decode_Class.gDecodeJsonNil)(new Data_Symbol.IsSymbol(function () {
      return "visibility";
  }))()())(new Data_Symbol.IsSymbol(function () {
      return "name";
  }))()())(new Data_Symbol.IsSymbol(function () {
      ...
      return "description";
  }))()())()))(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeJsonString)(Data_Argonaut_Decode_Class.gDecodeJsonNil)(new Data_Symbol.IsSymbol(function () {
      return "name";
  }))()())(new Data_Symbol.IsSymbol(function () {
      return "contents";
  }))()())()))(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeJsonString)(Data_Argonaut_Decode_Class.gDecodeJsonNil)(new Data_Symbol.IsSymbol(function () {
      ...
      return "contents";
  }))()())()))(Data_Argonaut_Parser.jsonParser(testPageJson));
  exports["Text"] = Text;
  ...
  exports["decodeInputSource"] = decodeInputSource;
  ...
  var component = (function () {
      var renderInput = function (v) {
          if (v.input instanceof Lynx_Data_Form.Text) {
              return Ocelot_Block_Input.input([ Halogen_HTML_Properties.placeholder(Data_Show.show(Lynx_Data_Expr.showExpr(Lynx_Data_Expr.exprString))(v.input.value0.placeholder)), Halogen_HTML_Properties.id_(v.key) ]);
          };
          if (v.input instanceof Lynx_Data_Form.Toggle) {
              return Ocelot_Block_Toggle.toggle([ Halogen_HTML_Properties.checked(true), Halogen_HTML_Properties.id_(v.key) ]);
          };
          throw new Error("Failed pattern match at Lynx.Page.Form line 98, column 25 - line 108, column 9: " + [ v.input.constructor.name ]);
      };
      var renderField = function (v) {
          return Ocelot_Block_FormField.field_({
              label: Halogen_HTML_Core.text(Data_Show.show(Lynx_Data_Expr.showExpr(Lynx_Data_Expr.exprString))(v.name)),
              helpText: Data_Maybe.Just.create(Data_Show.show(Lynx_Data_Expr.showExpr(Lynx_Data_Expr.exprString))(v.description)),
      ...
      var render = function (v) {
          return Ocelot_Block_Layout.section_((function () {
              ...
              throw new Error("Failed pattern match at Lynx.Page.Form line 70, column 7 - line 78, column 44: " + [ v.form.constructor.name ]);
          })());
      };
      var initialState = {
          form: new Data_Either.Left("Loading...")
      };
      var $$eval = function (v) {
          if (v instanceof Initialize) {
              return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value0)(Data_Functor["void"](Halogen_Query_HalogenM.functorHalogenM)(Data_Bifoldable.bitraverse_(Data_Either.bifoldableEither)(Halogen_Query_HalogenM.applicativeHalogenM)(function (e) {
                  return Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                      ...
                      $19.form = new Data_Either.Left(e);
                      return $19;
                  });
              })(function (f) {
                  return $$eval(new EvalForm(f, v.value0));
              })(Lynx_Data_Form.testPageEither)));
          };
          if (v instanceof EvalForm) {
              return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value1)(Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  var $23 = {};
                  for (var $24 in v1) {
                  ...
                  $23.form = Control_Applicative.pure(Data_Either.applicativeEither)(v.value0);
                  return $23;
              }))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
              }));
          };
          throw new Error("Failed pattern match at Lynx.Page.Form line 56, column 3 - line 56, column 56: " + [ v.constructor.name ]);
      };
  ...
  var component = function (dictMonadAff) {
      var render = function (v) {
          ...
          if (v instanceof Lynx_Route.Form) {
              return Halogen_HTML["slot'"](Halogen_Component_ChildPath.cp2)(Data_Unit.unit)(Lynx_Page_Form.component)(v.value0)(Data_Void.absurd);
          };
