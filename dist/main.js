...
(function(exports) {
          ...
          return function (page) {
              var setField = function (field) {
                  if (key === field.key) {
                      ...
                      throw new Error("Failed pattern match at Lynx.Data.Form (line 257, column 26 - line 265, column 71): " + [ field.input.constructor.name ]);
                  };
                  if (Data_Boolean.otherwise) {
                      return field;
                  };
                  throw new Error("Failed pattern match at Lynx.Data.Form (line 255, column 3 - line 255, column 39): " + [ field.constructor.name ]);
              };
  ...
  var keys = function (page) {
      var keysField = function (field) {
          var value = (function () {
              ...
              throw new Error("Failed pattern match at Lynx.Data.Form (line 237, column 13 - line 241, column 39): " + [ field.input.constructor.name ]);
          })();
          if (value instanceof Data_Maybe.Just) {
              ...
              throw new Error("Failed pattern match at Lynx.Data.Form (line 232, column 18 - line 234, column 48): " + [ v.constructor.name ]);
          };
          if (value instanceof Data_Maybe.Nothing) {
              return Data_Monoid.mempty(Data_Map_Internal.monoidMap(Data_Ord.ordString));
          };
          throw new Error("Failed pattern match at Lynx.Data.Form (line 231, column 21 - line 235, column 22): " + [ value.constructor.name ]);
      };
  ...
  var functorInputSource = new Data_Functor.Functor(function (f) {
      return function (m) {
          ...
          throw new Error("Failed pattern match at Lynx.Data.Form (line 109, column 8 - line 109, column 58): " + [ m.constructor.name ]);
      };
  });
  var food = {
  ...
  var foldableInputSource = new Data_Foldable.Foldable(function (dictMonoid) {
      return function (f) {
          return function (v) {
              ...
              throw new Error("Failed pattern match at Lynx.Data.Form (line 114, column 15 - line 117, column 21): " + [ v.constructor.name ]);
          };
      };
  }, function (f) {
  ...
  var traversableInputSource = new Data_Traversable.Traversable(function () {
      ...
      return function (f) {
          return function (v) {
              ...
              throw new Error("Failed pattern match at Lynx.Data.Form (line 123, column 16 - line 126, column 26): " + [ v.constructor.name ]);
          };
      };
  });
  var firstName = {
  ...
  var $$eval = function (get) {
      return function (page) {
          var evalInput = function (v) {
              ...
              throw new Error("Failed pattern match at Lynx.Data.Form (line 173, column 15 - line 222, column 39): " + [ v.constructor.name ]);
          };
