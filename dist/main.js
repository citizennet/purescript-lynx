...
(function(exports) {
          ...
          return function (page) {
              var setField = function (field) {
                  if (key === field.key) {
                      ...
                      throw new Error("Failed pattern match at Lynx.Data.Form (line 262, column 26 - line 270, column 72): " + [ field.input.constructor.name ]);
                  };
                  if (Data_Boolean.otherwise) {
                      return field;
                  };
                  throw new Error("Failed pattern match at Lynx.Data.Form (line 260, column 3 - line 260, column 39): " + [ field.constructor.name ]);
              };
  ...
  var keys = function (page) {
      var keysField = function (field) {
          var value = (function () {
              ...
              throw new Error("Failed pattern match at Lynx.Data.Form (line 242, column 13 - line 246, column 39): " + [ field.input.constructor.name ]);
          })();
          if (value instanceof Data_Maybe.Just) {
              ...
              throw new Error("Failed pattern match at Lynx.Data.Form (line 237, column 18 - line 239, column 48): " + [ v.constructor.name ]);
          };
          if (value instanceof Data_Maybe.Nothing) {
              return Data_Monoid.mempty(Data_Map_Internal.monoidMap(Data_Ord.ordString));
          };
          throw new Error("Failed pattern match at Lynx.Data.Form (line 236, column 21 - line 240, column 22): " + [ value.constructor.name ]);
      };
  ...
  var functorInputSource = new Data_Functor.Functor(function (f) {
      return function (m) {
          ...
          throw new Error("Failed pattern match at Lynx.Data.Form (line 114, column 8 - line 114, column 58): " + [ m.constructor.name ]);
      };
  });
  var food = {
  ...
  var foldableInputSource = new Data_Foldable.Foldable(function (dictMonoid) {
      return function (f) {
          return function (v) {
              ...
              throw new Error("Failed pattern match at Lynx.Data.Form (line 119, column 15 - line 122, column 21): " + [ v.constructor.name ]);
          };
      };
  }, function (f) {
  ...
  var traversableInputSource = new Data_Traversable.Traversable(function () {
      ...
      return function (f) {
          return function (v) {
              ...
              throw new Error("Failed pattern match at Lynx.Data.Form (line 128, column 16 - line 131, column 26): " + [ v.constructor.name ]);
          };
      };
  });
  var firstName = {
  ...
  var $$eval = function (get) {
      return function (page) {
          var evalInput = function (v) {
              ...
              throw new Error("Failed pattern match at Lynx.Data.Form (line 178, column 15 - line 227, column 39): " + [ v.constructor.name ]);
          };
