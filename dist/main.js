...
(function(exports) {
  ...
  var string_ = function ($244) {
      return Val.create($$String.create($244));
  };
  ...
  var evalExpr = function (get) {
      return function (v) {
          ...
          if (v instanceof Print) {
              return Data_Functor.map(Data_Either.functorEither)(function ($246) {
                  return $$String.create(print($246));
          ...
          throw new Error("Failed pattern match at Lynx.Data.Expr (line 186, column 16 - line 203, column 60): " + [ v.constructor.name ]);
      };
  }; 
  var boolean_ = function ($248) {
      return Val.create($$Boolean.create($248));
  };
...
(function(exports) {
  ...
  var component = (function () {
          ...
          return function (val) {
              return function (field) {
                  if (key === field.key) {
                      ...
                      throw new Error("Failed pattern match at Lynx.Page.Form (line 226, column 26 - line 230, column 71): " + [ field.input.constructor.name ]);
                  };
                  if (Data_Boolean.otherwise) {
                      return field;
                  };
                  throw new Error("Failed pattern match at Lynx.Page.Form (line 224, column 3 - line 224, column 58): " + [ key.constructor.name, val.constructor.name, field.constructor.name ]);
              };
          };
      };
      ...
      var keysField = function (field) {
          var v = function (v1) {
              var v2 = function (v3) {
                  var v4 = function (v5) {
                      ...
                      if (field.input instanceof Lynx_Data_Form.Toggle && field["input"]["value0"]["default"] instanceof Data_Maybe.Just) {
                          var $55 = Lynx_Data_Expr.evalExpr(Data_Function["const"](Data_Maybe.Nothing.value))(field["input"]["value0"]["default"].value0);
                          if ($55 instanceof Data_Either.Right) {
                              return Data_Map_Internal.singleton(field.key)($55.value0);
                          };
                          return v6(true);
                      };
                      return v6(true);
                  ...
                  if (field.input instanceof Lynx_Data_Form.Toggle && field.input.value0.value instanceof Lynx_Data_Form.UserInput) {
                      var $61 = Lynx_Data_Expr.evalExpr(Data_Function["const"](Data_Maybe.Nothing.value))(field.input.value0.value.value0);
                      if ($61 instanceof Data_Either.Right) {
                          return Data_Map_Internal.singleton(field.key)($61.value0);
                      };
                      return v4(true);
                  };
                  return v4(true);
              ...
              if (field.input instanceof Lynx_Data_Form.Text && field["input"]["value0"]["default"] instanceof Data_Maybe.Just) {
                  var $67 = Lynx_Data_Expr.evalExpr(Data_Function["const"](Data_Maybe.Nothing.value))(field["input"]["value0"]["default"].value0);
                  if ($67 instanceof Data_Either.Right) {
                      return Data_Map_Internal.singleton(field.key)($67.value0);
                  };
                  return v2(true);
              };
              return v2(true);
          ...
          if (field.input instanceof Lynx_Data_Form.Text && field.input.value0.value instanceof Lynx_Data_Form.UserInput) {
              var $73 = Lynx_Data_Expr.evalExpr(Data_Function["const"](Data_Maybe.Nothing.value))(field.input.value0.value.value0);
              if ($73 instanceof Data_Either.Right) {
                  return Data_Map_Internal.singleton(field.key)($73.value0);
              };
              return v(true);
          };
          return v(true);
      ...
      var getValue = function (v) {
          if (v.value instanceof Lynx_Data_Form.UserInput) {
      ...
      var renderInput = function (v) {
          if (v.input instanceof Lynx_Data_Form.Text) {
              return Ocelot_Block_Input.input([ Halogen_HTML_Properties.value(Data_Maybe.fromMaybe("")(Control_Bind.bindFlipped(Data_Maybe.bindMaybe)(Lynx_Data_Expr.toString)(getValue(v.input.value0)))), Halogen_HTML_Properties.placeholder(Lynx_Data_Expr.print(v.input.value0.placeholder)), Halogen_HTML_Properties.id_(v.key) ]);
          };
          if (v.input instanceof Lynx_Data_Form.Toggle) {
              return Ocelot_Block_Toggle.toggle([ Halogen_HTML_Properties.checked(Data_Maybe.fromMaybe(false)(Control_Bind.bindFlipped(Data_Maybe.bindMaybe)(Lynx_Data_Expr.toBoolean)(getValue(v.input.value0)))), Halogen_HTML_Properties.id_(v.key), Halogen_HTML_Events.onChecked(Halogen_HTML_Events.input(function ($136) {
                  return UpdateKey.create(v.key)(Lynx_Data_Expr["Boolean"].create($136));
              })) ]);
          };
          throw new Error("Failed pattern match at Lynx.Page.Form (line 195, column 25 - line 207, column 10): " + [ v.input.constructor.name ]);
      };
      ...
      var $$eval = function (v) {
          if (v instanceof Initialize) {
              return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value0)(Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  ...
                  $111.values = keysPage(Lynx_Data_Form.testPage);
                  return $111;
              }))(function () {
                  return Data_Functor["void"](Halogen_Query_HalogenM.functorHalogenM)(Data_Bifoldable.bitraverse_(Data_Either.bifoldableEither)(Halogen_Query_HalogenM.applicativeHalogenM)(function (e) {
                      return Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                          ...
                          $114.form = new Network_RemoteData.Failure(e);
                          return $114;
                      });
                  })(function (f) {
          ...
          if (v instanceof EvalForm) {
              return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value1)(Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  ...
                  return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                      ...
                      $119.form = Data_Functor.map(Network_RemoteData.functorRemoteData)(function (v3) {
                          return {
                              expr: v.value0,
                              evaled: v3
                          };
          ...
          if (v instanceof UpdateKey) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                  ...
                  $125.values = Data_Map_Internal.insert(Data_Ord.ordString)(v.value0)(v.value1)(state.values);
                  return $125;
              }))(function () {
